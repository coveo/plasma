...
export class DatePickerDropdownConnectedSingleDateExamples extends React.Component<
    DatePickerDropdownConnectedSingleDateExamplesProps
> {
    componentWillMount() {
        this.props.onRender();
    }
            ...
            <div className="mt2">
                <div className="form-group">
                    <label className="form-control-label">
                        Date picker dropdown with single date, no time, and Redux state
                    </label>
                ...
                <div className="form-group">
                    <label className="form-control-label">
                        Simple date picker dropdown with single date, no time, and Redux state
                    </label>
                    <DatePickerDropdownConnected
