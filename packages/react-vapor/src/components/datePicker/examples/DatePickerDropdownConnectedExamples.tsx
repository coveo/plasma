...
export class DatePickerDropdownConnectedExamples extends React.Component<any, any> {
    static description =
        'Date Pickers allow users to select a date or date range, and may further allow time of day selection.';
            ...
            <div className="mt2">
                ...
                <div className="form-group">
                    <label className="form-control-label">
                        Date picker dropdown with Redux state and selected date range set on render
                    </label>
                    <DatePickerDropdownConnected
                ...
                <div className="form-group">
                    <label className="form-control-label">
                        Date picker dropdown with a range limit of 3 days Redux state
                    </label>
                    <DatePickerDropdownConnected
                ...
                <div className="form-group">
                    <label className="form-control-label">
                        Clearable date picker dropdown initially unselected with Redux state
                    </label>
                    <DatePickerDropdownConnected
                ...
                <div className="form-group">
                    <label className="form-control-label">
                        Clearable date picker dropdown initially unselected with Redux state without time
                    </label>
                    <DatePickerDropdownConnected
                ...
                <div className="form-group">
                    <label className="form-control-label">
                        Clearable date picker dropdown initially unselected with Redux state without time and without
                        setToNow
                    </label>
                    <DatePickerDropdownConnected
