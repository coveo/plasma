...
describe('<XYChart />', () => {
    it('should not throw', () => {
        expect(() => {
            ...
            shallow(<XYChart height={10} width={50} series={XYChartContextMock.series.concat({label: 'name', data: []})} padding={{top: 10}} />);
            shallow(
                <XYChart
                    height={10}
                    width={50}
    ...
    it('should render a context provider', () => {
        ...
        const component = shallow(<XYChart height={100} width={100} series={XYChartContextMock.series} colorPattern={colorPattern} />);
