...
export class SyncFeedbackExample extends React.Component<any, any> {
    render() {
        return (
            ...
            <SyncFeedback state={SyncFeedbackState.SYNCING} feedback='This message is a SyncFeedback component on state SYNCING' />
                        <SyncFeedback state={SyncFeedbackState.SUCCESS} feedback='This message is a SyncFeedback component on state SUCCESS' />
                        <SyncFeedback state={SyncFeedbackState.ERROR} feedback='This message is a SyncFeedback component on state ERROR' />
                    </div>
                </div>
            </div>
        );
