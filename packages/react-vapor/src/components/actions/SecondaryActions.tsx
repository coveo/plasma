...
export interface ISecondaryActionsProps
    extends ISecondaryActionsOwnProps,
        ISecondaryActionsStateProps,
        ISecondaryActionChildrenProps {}
...
export class SecondaryActions extends React.Component<ISecondaryActionsProps, any> {
    render() {
        ...
        return <div className="dropdown action primary-action">{actions}</div>;
    }
}
