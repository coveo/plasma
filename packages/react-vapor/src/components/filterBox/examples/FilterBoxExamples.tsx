        ...
        return (
            <div className="mt2" style={{width: 400}}>
                ...
                <div className="form-group">
                    ...
                    <FilterBox
                        id="FilterBoxExampleComponentWithPlaceholder"
                        filterPlaceholder="Filter through results"
                    />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    ...
                    <FilterBox
                        id="FilterBoxExampleComponentWithTruncate"
                        filterPlaceholder="Long filter placeholder"
                        truncate
                    />
                </div>
                <div className="form-group">
