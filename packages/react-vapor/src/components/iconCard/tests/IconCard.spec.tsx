...
describe('IconCard', () => {
    ...
    it('does not render buttons for disabled choices', () => {
        const mockOnClick = jest.fn();
        render(
            <IconCard
                title="Title"
    ...
    it('displays choices vertically if choicesLayout is set to vertical', () => {
        render(
            <IconCard
                title="Title"
                svgName="home"
        ...
        const drawer = screen.getByRole('list');
        expect(drawer).toHaveClass('mod-vertical');
    });
});
