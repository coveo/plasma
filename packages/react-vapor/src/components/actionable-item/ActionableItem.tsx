            ...
            <div {..._.omit(this.props, 'actions', 'onItemClick', 'dropProps', 'containerClassName')}>
                <div
                    className={classNames(
                        ...
                        'actionable-item-content align-middle inline-block border-color-medium-grey mod-border',
                    ...
                    <Drop
                        ...
                        renderOpenButton={(onClick: () => void) => (
                            <div
                                onClick={onClick}
                                className={classNames(
                                    'actionable-item-dots align-middle cursor-pointer inline-block mod-border-top mod-border-right border-color-medium-grey mod-border-bottom',
