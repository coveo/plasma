...
export default function Checkboxes() {
    useEffect(() => {
        document.querySelectorAll('.js-prop-indeterminate input').forEach((n: HTMLInputElement) => {
            n.indeterminate = true;
        });
    });

    return (
        <VaporComponent id="checkboxes" title="Checkboxes" usage="Custom checkboxes" withSource>
