    ...
    >
        <div className="coveo-form">
            ...
            <div id="textarea1" className="input-field form-group js-autosized">
                <textarea required />
                <label htmlFor="textarea1">Textarea empty</label>
            </div>
            ...
            <div className="input-field form-group">
                ...
                <p className="description">
                    Lorem ipsum dolor sit amet, interdum est eu. A tellus condimentum hendrerit enim, ligula fusce
                    vitae, leo et fusce mauris lorem suscipit scelerisque. Vel arcu, non vestibulum suspendisse non
                    lectus magnis suspendisse, aliquam magna commodo. Nascetur eleifend at faucibus faucibus, nulla
                    fringilla, mauris ultrices posuere in, ut dolor cras rhoncus.
                </p>
            </div>
        </div>
    </VaporComponent>
