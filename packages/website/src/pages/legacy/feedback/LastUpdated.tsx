...
import code from '@examples/legacy/feedback/LastUpdated/LastUpdated.example.tsx';
import specificTime from '@examples/legacy/feedback/LastUpdated/LastUpdatedSpecifiedTime.example.tsx';
