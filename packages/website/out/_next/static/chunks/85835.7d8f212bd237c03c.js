...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [85835],
    {
        85835: function (r, t, o) {
            (o.r(t),
                o.d(t, {
                    atomic_load_more_children_results: function () {
                        return m;
                    },
                }));
            var i = o(5991),
                ...
                s = o(53630),
                c = o(18043);
            (o(66038), o(87856), o(27964));
            var d = function (r, t, o, i) {
                var e,
                    a = arguments.length,
            ...
            let m = class {
                constructor(r) {
                    ((0, i.r)(this, r), (this.label = 'load-all-results'));
                }
                get collection() {
                    return this.result.raw.foldingcollection
                        ? this.foldedResultListState.results.find(
                              (r) => r.result.raw.foldingcollection === this.result.raw.foldingcollection,
                          )
                        : null;
                }
                loadFullCollection() {
                    this.host.dispatchEvent((0, e.b)('atomic/loadCollection', this.collection));
                }
                get hasMoreResults() {
                    var r;
                    return null === (r = this.collection) || void 0 === r ? void 0 : r.moreResultsAvailable;
                }
                get isLoading() {
                    var r;
                    return !!(null === (r = this.collection) || void 0 === r ? void 0 : r.isLoadingMoreResults);
                }
                get hasChildren() {
                    var r;
                    return !!(null === (r = this.collection) || void 0 === r ? void 0 : r.children.length);
                }
                get buttonClass() {
                    return this.hasChildren ? 'has-children' : '';
                }
                get wrapperClass() {
                    return (0, l.g)('list', this.displayConfig.density, this.displayConfig.imageSize).join(' ');
                }
                render() {
                    return this.foldedResultListState && this.collection
                        ? (0, i.h)(
                              'div',
        ...
        2456: function (r, t, o) {
            ...
            class a {
                constructor(r, t, o, i) {
                    ((this.children = r), (this.display = t), (this.density = o), (this.imageSize = i));
                }
                getImageSizeFromSections() {
                    var r;
                    let t =
                        null === (r = this.getSection('atomic-result-section-visual')) || void 0 === r
                            ? void 0
                            : r.getAttribute('image-size');
                    if (t) return t;
                }
                getSection(r) {
                    return Array.from(this.children).find((t) => t.tagName.toLowerCase() === r);
                }
                getClasses(r) {
                    var t;
                    let o = e(
                        this.display,
                        this.density,
                        null !== (t = this.getImageSizeFromSections()) && void 0 !== t ? t : this.imageSize,
                    );
                    return ((r ? (0, i.c)(r) : (0, i.c)(this.children)) && o.push('with-sections'), o);
                }
            }
        },
        27964: function (r, t, o) {
            o.d(t, {
                c: function () {
                    return n;
                },
            ...
            function a(r) {
                return !!(0, i.e)(r) && e.has(r.tagName.toLowerCase());
            }
            function n(r) {
                return 'string' == typeof r
                    ? Array.from(e.values()).some((t) => r.includes(t))
                    : Array.from(r).some((r) => a(r));
            }
        },
    },
]);
