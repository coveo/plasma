...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [51890],
    {
        51890: function (r, t, o) {
            (o.r(t),
                o.d(t, {
                    atomic_ipx_modal: function () {
                        return l;
                    },
                }));
            var i = o(5991),
            ...
            let l = class {
                constructor(r) {
                    ((0, i.r)(this, r),
                        ...
                        (this.isOpen = !1),
                        (this.hasFooterSlotElements = !0),
                        (this.updateBreakpoints = (0, n.o)(() => (0, a.u)(this.host))));
                }
                async watchToggleOpen(r) {
                    let t = 'atomic-ipx-modal-opened';
                    if (r) {
                        (document.body.classList.add(t), this.bindings.interfaceElement.classList.add(t));
                        return;
                    }
                    (document.body.classList.remove(t), this.bindings.interfaceElement.classList.remove(t));
                }
                getClasses() {
                    let r = [];
                    return (this.isOpen && r.push('open'), r.push('dialog'), r);
                }
                onWindowTouchMove(r) {
                    this.isOpen && r.preventDefault();
                }
                componentWillLoad() {
                    this.hasFooterSlotElements = !!this.host.querySelector('[slot="footer"]');
                }
                componentDidLoad() {
                    let r = this.host.id || (0, n.r)('atomic-ipx-modal-');
                    ((this.host.id = r), this.watchToggleOpen(this.isOpen));
                }
                render() {
                    return (
                        ...
                        (0, i.h)(
                            i.H,
                            {class: this.getClasses().join(' '), part: 'atomic-ipx-modal'},
                            (0, i.h)(
                                'div',
                                {part: 'backdrop'},
                                (0, i.h)(
                                    () =>
                                        (0, i.h)(
                                            'atomic-ipx-body',
                                            {isOpen: this.isOpen, displayFooterSlot: this.hasFooterSlotElements},
                                            (0, i.h)('slot', {name: 'header', slot: 'header'}),
                                            (0, i.h)('slot', {name: 'body', slot: 'body'}),
                                            (0, i.h)('slot', {name: 'footer', slot: 'footer'}),
                                        ),
                                    null,
                                ),
                            ),
                        ...
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), d((0, i.g)(this)), u && u.call(this)));
                        }),
