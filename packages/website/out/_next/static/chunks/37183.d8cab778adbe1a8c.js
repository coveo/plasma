...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [37183],
    {
        37183: function (r, t, e) {
            (e.r(t),
                e.d(t, {
                    atomic_automatic_facet_generator: function () {
                        return d;
                    },
                }));
            var o = e(5991),
            ...
            let d = class {
                constructor(r) {
                    ((0, o.r)(this, r), (this.areCollapsed = !0), (this.numberOfValues = 8));
                }
                initialize() {
                    (this.validateProps(),
                        (this.searchStatus = (0, a.E)(this.bindings.engine)),
                        (this.automaticFacetGenerator = (0, a.A)(this.bindings.engine, {
                            options: {desiredCount: this.desiredCount, numberOfValues: this.numberOfValues},
                        })));
                }
                validateProps() {
                    new i.S({areCollapsed: new i.B({default: !0, required: !1})}).validate({
                        areCollapsed: this.areCollapsed,
                    });
                }
                render() {
                    let r = this.automaticFacetGeneratorState.automaticFacets.map((r) =>
                        (0, o.h)('atomic-automatic-facet', {
                            key: r.state.field,
                            field: r.state.field,
                            facetId: r.state.field,
                            facet: r,
                    ...
                    return this.searchStatus.state.firstSearchExecuted
                        ? r
                        : Array.from({length: this.desiredCount}, () =>
                              (0, o.h)(l.F, {numberOfValues: this.numberOfValues, isCollapsed: this.areCollapsed}),
                          );
                }
            };
            (s([(0, n.I)()], d.prototype, 'bindings', void 0),
                s([(0, n.B)('automaticFacetGenerator')], d.prototype, 'automaticFacetGeneratorState', void 0),
                s([(0, n.B)('searchStatus')], d.prototype, 'searchStatusState', void 0),
                (d.style =
        ...
        98214: function (r, t, e) {
            ...
            var o = class extends Error {
                ...
                i = class {
                    ...
                    validate(r = {}, t = '') {
                        let e = {...this.default, ...r},
                            i = [];
                        for (let r in this.definition) {
                            let t = this.definition[r].validate(e[r]);
                            t && i.push(`${r}: ${t}`);
                        }
                        if (i.length)
                            throw (
  ...
  `;
                    ...
                    get default() {
                        ...
                        for (let t in this.definition) {
                            let e = this.definition[t].default;
                            void 0 !== e && (r[t] = e);
                        }
                        return r;
                    }
            ...
            var s = class {
                ...
                m = class {
                    ...
                    validate(r) {
                        let {emptyAllowed: t, url: e, regex: o, constrainTo: i} = this.config,
                        ...
                        if (e && !c.test(r)) return 'value is not a valid URL.';
                        if (o && !o.test(r)) return `value did not match provided regex ${o}`;
                        if (i && !i.includes(r)) {
                            let r = i.join(', ');
        ...
        5812: function (r, t, e) {
            ...
            var o = e(5991),
                i = e(66038);
            let a = ({numberOfValues: r, isCollapsed: t}) => {
                let e = [];
                for (let t = 0; t < r; t++) {
                    let r = `${(0, i.g)(60, 100)}%`,
                        t = `${(0, i.g)(0.3, 1)}`;
                    e.push((0, o.h)('div', {class: 'flex bg-neutral h-5 mt-4', style: {width: r, opacity: t}}));
                }
                return (0, o.h)(
                    'div',
                    {
                    ...
                    (0, o.h)('div', {class: 'bg-neutral rounded h-8', style: {width: `${(0, i.g)(25, 75)}%`}}),
                    !t && (0, o.h)('div', {class: 'mt-7'}, e),
                );
            };
        },
        8807: function (r, t, e) {
                    ...
                    ((t.componentWillLoad = function () {
                        ...
                        (t.render = function () {
                            return this.error
                                ...
                                : this.bindings
                                  ? ((0, o.g)(this).setAttribute(m, 'true'), g && g.call(this))
                                  : (0, o.h)(n, null);
                        }),
                        (t.disconnectedCallback = function () {
                            let r = (0, o.g)(this);
                            (r.setAttribute(m, 'false'), r.setAttribute(p, 'false'), b(), f && f.call(this));
                        }),
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), c((0, o.g)(this)), h && h.call(this)));
                        }),
