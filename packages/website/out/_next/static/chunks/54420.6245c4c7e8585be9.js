    ...
    [54420],
    {
        54420: function (e, t, a) {
            ...
            function n(e) {
                let t = [],
                    a = e.split(/\t+|\r+|\n+| +/);
                for (let e = 0; e < a.length; ++e) a[e].length > 0 && t.push(a[e]);
                return t;
            }
            var o = n('true false'),
                i = n(`
...
`),
                d = n(`
					 ...
					 *=
					 ...
					 <<=
					 `),
                x = /[_\p{XID_Start}]\p{XID_Continue}*/u,
                f = 'variable.predefined',
                _ = {
                    tokenPostfix: '.wgsl',
                    ...
                    tokenizer: {
                        root: [
                            [/enable|requires|diagnostic/, 'keyword', '@directive'],
                            [
                                x,
                                {
                                    cases: {
                                        ...
                                        '@predeclared_enums': f,
                                        '@predeclared_types': f,
                                        '@predeclared_type_generators': f,
                                        '@predeclared_type_aliases': f,
