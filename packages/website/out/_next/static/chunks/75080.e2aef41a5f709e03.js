...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [75080],
    {
        80421: function (t, r, e) {
            ...
            function a(t, r = !1) {
                function e() {
                    let t = (0, o.b)('atomic/accessibility/findAriaLive', {});
                    document.dispatchEvent(t);
                    let {element: r} = t.detail;
                    return r;
                }
                return (o, i) => {
                    let {componentWillRender: a} = o;
                    (Object.defineProperty(o, i, {
                        set: (o) => {
                            var i;
                            null === (i = e()) || void 0 === i || i.updateMessage(t, o, r);
                        },
                    }),
                        (o.componentWillRender = function () {
                            var o;
                            (a && a.call(this), null === (o = e()) || void 0 === o || o.registerRegion(t, r));
                        }));
                };
            }
            function n() {
                return (t, r) => {
                    ...
                    t.componentWillLoad = function () {
                        ...
                        let d = {
                            ...
                            focus: async () => {
                                (await (0, i.d)(), null == o || o.focus(), null == s || s());
                            },
                            focusAfterSearch: () => (
            ...
            function l(t) {
                ...
                return null !==
                    (r = (function* t(r) {
                        ...
                        for (let o of (r instanceof HTMLSlotElement
        ...
        75080: function (t, r, e) {
            (e.r(r),
                e.d(r, {
                    atomic_focus_trap: function () {
                        return c;
                    },
                    atomic_modal: function () {
                        return p;
                    },
                }));
            var o = e(5991),
            ...
            let c = class {
                    ...
                    hide(t) {
                        t.hasAttribute('aria-hidden') ||
                            ...
                            'atomic-aria-live' === t.tagName.toLowerCase() ||
                            (t.setAttribute('aria-hidden', 'true'), this.hiddenElements.push(t));
                    }
                    showAll() {
                        let t;
                        for (; (t = this.hiddenElements.pop()); ) t.removeAttribute('aria-hidden');
                    }
                    hideSiblingsRecursively(t) {
                        let r = (0, a.u)(t);
                        null !== r &&
                            (Array.from(r.children).forEach((r) => {
                                r === t || (r.assignedSlot && (0, a.n)(this.host, r.assignedSlot)) || this.hide(r);
                            }),
                            r !== this.scope && this.hideSiblingsRecursively(r));
                    }
                    showSelf() {
                    ...
                    async onDeactivated(t) {
                        var r;
                        (this.showAll(),
                            t || (await (0, a.d)(), null === (r = this.source) || void 0 === r || r.focus()),
                            this.hideSelf());
                    }
                    async onActivated(t) {
                        var r;
                        (this.showSelf(),
                            t || (await (0, a.d)(), null === (r = (0, i.g)(this.host)) || void 0 === r || r.focus()),
                            this.hideSiblingsRecursively(this.host));
                    }
                    async activeChanged(t, r) {
                        let e = t === r;
                        t ? await this.onActivated(e) : await this.onDeactivated(e);
                    }
                    onFocusChanged(t) {
                        var r;
                        if (!t.target || !this.active) return;
                        let e = (0, a.q)();
                        (e && ((0, a.n)(this.host, e) || !(0, a.n)(this.scope, e))) ||
                            null === (r = (0, i.g)(this.host)) ||
                            void 0 === r ||
                            r.focus();
                    }
                    connectedCallback() {
                    ...
                    get parentToHide() {
                        var t;
                        return null !== (t = this.container) && void 0 !== t ? t : this.host;
                    }
                    get host() {
                        return (0, o.g)(this);
                    }
                    static get watchers() {
                        return {active: ['activeChanged']};
                    }
                },
                p = class {
                    constructor(t) {
                        ((0, o.r)(this, t),
                            (this.animationEnded = (0, o.c)(this, 'animationEnded', 7)),
                            (this.fullscreen = !1),
                            (this.isOpen = !1),
                            (this.close = () => (this.isOpen = !1)),
                            (this.boundary = 'page'),
                            (this.wasEverOpened = !1),
                            (this.headerId = (0, a.r)('atomic-modal-header-')),
                            (this.currentWatchToggleOpenExecution = 0),
                            (this.updateBreakpoints = (0, a.o)(() => (0, d.u)(this.host))));
                    }
                    async watchToggleOpen(t) {
                        let r = ++this.currentWatchToggleOpenExecution,
                            e = 'atomic-modal-opened';
                        if (t) {
                            if (
                                ((this.wasEverOpened = !0),
                                document.body.classList.add(e),
                                this.bindings.interfaceElement.classList.add(e),
                                await this.waitForAnimationEnded(),
                                r !== this.currentWatchToggleOpenExecution)
                            )
                                return;
                            this.focusTrap.active = !0;
                        } else {
                            if (
                                (document.body.classList.remove(e),
                                this.bindings.interfaceElement.classList.remove(e),
                                (0, n.a)() && (await this.waitForAnimationEnded()),
                                r !== this.currentWatchToggleOpenExecution)
                            )
                                return;
                            this.focusTrap.active = !1;
                        }
                    }
                    handleCloseOnEscape(t) {
                        var r;
                        (null === (r = t.key) || void 0 === r ? void 0 : r.toLowerCase()) === 'escape' && this.close();
                    }
                    waitForAnimationEnded() {
                        return new Promise((t) => (0, l.l)(this.animatableContainer, 'animationend', t));
                    }
                    getClasses() {
                        let t = [];
                        return (
                            this.isOpen && t.push('open'),
                            this.fullscreen ? t.push('fullscreen') : t.push('dialog'),
                            t
                        );
                    }
                    onWindowTouchMove(t) {
          ...
          `,
                                        onClick: (t) => t.target === t.currentTarget && this.close(),
                                    },
                                    (0, o.h)(
                                        'atomic-focus-trap',
                                        {
                                            ...
                                            source: this.source,
                                            container: null !== (t = this.container) && void 0 !== t ? t : this.host,
                                            ref: (t) => (this.focusTrap = t),
                                            scope: this.scope,
                                        },
                                        (0, o.h)(
                                            () =>
          ...
          ${this.wasEverOpened ? '' : 'invisible'}`,
                                                        ...
                                                        ref: (t) => (this.animatableContainer = t),
                                                    },
                                                    (0, o.h)(
                                                        'header',
                                                        ...
                                                        (0, o.h)(
                                                            ...
                                                            (0, o.h)('slot', {name: 'header'}),
                                                        ),
                                                    ),
                                                    (0, o.h)('hr', {part: 'header-ruler', class: 'border-neutral'}),
                                                    (0, o.h)(
                                                        'div',
                                                        {
                                                            part: 'body-wrapper',
                                                            ...
                                                            'div',
                                                            {
                                                                ...
                                                                ref: (t) =>
                                                                    null == t
                                                                        ...
                                                                        : t.addEventListener(
                                                                              'touchmove',
                                                                              (t) => this.isOpen && t.stopPropagation(),
                                                                              {passive: !1},
                                                                          ),
                                                            },
                                                            (0, o.h)('slot', {name: 'body'}),
                                                        ),
                                                    ),
                                                    (0, o.h)(
                                                        'footer',
                                                        ...
                                                        (0, o.h)(
                                                            'div',
                                                            {part: 'footer', class: 'w-full max-w-lg'},
                                                            (0, o.h)('slot', {name: 'footer'}),
                                                        ),
                                                    ),
                                                ),
                                            null,
            ...
            })([(0, s.I)()], p.prototype, 'bindings', void 0),
                (p.style =
        ...
        92695: function (t, r, e) {
            function o() {
                let t = /iPad|iPhone|iPod/.test(navigator.userAgent),
                    r = navigator.userAgent.includes('Macintosh'),
                        ...
                        (r.componentDidRender = function () {
                            ...
                            'false' !== t.getAttribute(p) &&
                                ...
                                'false' === t.getAttribute(m) &&
                                    (t.setAttribute(m, 'true'), c((0, o.g)(this)), w && w.call(this)));
                        }),
