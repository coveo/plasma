(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        61683, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
        95153, 97612, 73877, 51843, 96429, 78364, 27682, 36569, 89613, 73492, 17036,
    ],
    {
        39979: function (r, t, e) {
            'use strict';
            (e.r(t),
                e.d(t, {
                    atomic_load_more_results: function () {
                        return s;
                    },
                }));
            var o = e(5991),
            ...
            let s = class {
                ...
                initialize() {
                    ((this.querySummary = (0, i.e)(this.bindings.engine)),
                        (this.resultList = (0, i.i)(this.bindings.engine, {options: {fieldsToInclude: []}})));
                }
                wrapHighlight(r) {
                    return `<span class="font-bold text-on-background" part="highlight">${r}</span>`;
                }
                renderShowingResults() {
                    let r = this.bindings.i18n.language,
                        t = this.bindings.i18n.t('showing-results-of-load-more', {
                            interpolation: {escapeValue: !1},
                            last: this.wrapHighlight(this.querySummaryState.lastResult.toLocaleString(r)),
                            total: this.wrapHighlight(this.querySummaryState.total.toLocaleString(r)),
                        });
                    return (0, o.h)('div', {
                ...
                renderProgressBar() {
                    let r = (this.querySummaryState.lastResult / this.querySummaryState.total) * 100,
                        t = `${Math.ceil(r)}%`;
                    return (0, o.h)(
                        'div',
                        {part: 'progress-bar', class: 'relative w-72 h-1 my-2 rounded bg-neutral'},
                        (0, o.h)('div', {
                ...
                async onClick() {
                    var r;
                    (null === (r = this.bindings.store.state.resultList) || void 0 === r || r.focusOnNextNewResult(),
                        ...
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), d((0, o.g)(this)), h && h.call(this)));
                        }),
