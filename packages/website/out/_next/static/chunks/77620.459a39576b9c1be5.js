                ...
                s = (e, t, r, o) => {
                    if ((t && 'object' == typeof t) || 'function' == typeof t)
                        for (let n of m(t))
                            c.call(e, n) ||
                                n === r ||
                                i(e, n, {get: () => t[n], enumerable: !(o = a(t, n)) || o.enumerable});
                    return e;
                },
                l = {};
            (s(l, n, 'default'), o && s(o, n, 'default'));
            var d = [
                    'area',
                    'base',
                    'br',
                ...
                p = {
                    ...
                    onEnterRules: [
                        {
                            beforeText: RegExp(`<(?!(?:${d.join('|')}))(\\w[\\w\\d]*)([^/>]*(?!/)>)[^<]*$`, 'i'),
                            afterText: /^<\/(\w[\w\d]*)\s*>$/i,
                            action: {indentAction: l.languages.IndentAction.IndentOutdent},
                        },
                        {
                            beforeText: RegExp(`<(?!(?:${d.join('|')}))(\\w[\\w\\d]*)([^/>]*(?!/)>)[^<]*$`, 'i'),
