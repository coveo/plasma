(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        80696, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
        95153, 97612, 73877, 51843, 96429, 78364, 27682, 36569, 89613, 73492, 17036,
    ],
    {
        21913: function (r, t, e) {
            'use strict';
            (e.r(t),
                e.d(t, {
                    atomic_aria_live: function () {
                        return l;
                    },
                    atomic_relevance_inspector: function () {
                        return s;
                    },
                }));
            var o = e(5991),
            ...
            let l = class {
                    constructor(r) {
                        ((0, o.r)(this, r),
                            (this.regions = {}),
                            (this.messagesQueue = (function (r) {
                                let t = [],
                                    e = null;
                                function o() {
                                    let r = t.shift();
                                    r ? r.execute() : (clearInterval(e), (e = null));
                                }
                                function i(r) {
                                    t = t.filter((t) => t.id !== r);
                                }
                                return {
                                    enqueue(a, n) {
                                        (n && i(n),
                                            t.push({id: n, execute: a}),
                                            null === e && (o(), (e = setInterval(o, r.delay))));
                                    },
                                    clear() {
                                        t = [];
                                    },
                                    cancelActionIfQueued: i,
                                };
                            })({delay: 500})),
                            (this.id = (0, i.r)('aria-live-')));
                    }
                    onFindAriaLive({detail: r}) {
                        (r.element && this.isInSearchInterface) || (r.element = this.host);
                    }
                    get isInSearchInterface() {
                        let r = this.host;
                        for (; r; ) {
                            if ('ATOMIC-SEARCH-INTERFACE' === r.tagName) return !0;
                            r = r.parentElement;
                        }
                        return !1;
                    }
                    async updateMessage(r, t, e) {
                        let o = () => (this.regions = {...this.regions, [r]: {assertive: e, message: t}});
                        t ? this.messagesQueue.enqueue(o, r) : (this.messagesQueue.cancelActionIfQueued(r), o());
                    }
                    async registerRegion(r, t) {
                        r in this.regions || (this.regions = {...this.regions, [r]: {assertive: t, message: ''}});
                    }
                    ...
                    render() {
                        return (0, o.h)(
                            ...
                            Object.entries(this.regions).map(([r, {assertive: t, message: e}]) =>
                                (0, o.h)(
                                    'div',
                                    {
                                        key: r,
                ...
                s = class {
                    constructor(r) {
                        ((0, o.r)(this, r),
                            (this.closeRelevanceInspector = (0, o.c)(this, 'atomic/relevanceInspector/close', 7)),
                            (this.open = !1));
                    }
                    render() {
                        return (0, o.h)(
                            'atomic-modal',
                            {
                                ...
                                close: () => {
                                    var r;
                                    null === (r = this.closeRelevanceInspector) || void 0 === r || r.emit();
                                },
                            },
                            (0, o.h)('p', {slot: 'header'}, 'Open the relevance inspector'),
                            (0, o.h)(
                                'p',
                                {slot: 'body'},
                            ...
                            (0, o.h)(
                                'div',
                                {slot: 'footer', class: 'w-full flex justify-end items-center'},
                                (0, o.h)(
                                    n.B,
                                    {
                                        ...
                                        onClick: () => {
                                            var r;
                                            return null === (r = this.closeRelevanceInspector) || void 0 === r
                                                ? void 0
                                                : r.emit();
                                        },
                                    },
                    ...
                    extractEnvironmentFromPlatformURL() {
                        var r, t, e, o;
                        let {platformUrl: i} = this.bindings.engine.state.configuration,
                            a = 'prod',
                            n = i.match(/^https:\/\/platform(?<env>dev|stg|hipaa)/);
                        if (n)
                            return null !== (t = null === (r = n.groups) || void 0 === r ? void 0 : r.env) &&
                                void 0 !== t
                                ? t
                                : a;
                        let l = i.match(/^https:\/\/[a-z0-9]+\.org(?<env>dev|stg|hipaa)/);
                        return l &&
                            null !== (o = null === (e = l.groups) || void 0 === e ? void 0 : e.env) &&
                            void 0 !== o
                            ? o
                            : a;
                    }
                    get adminHref() {
                        let {organizationId: r} = this.bindings.engine.state.configuration,
                            {admin: t} = (0, a.r)(r, this.extractEnvironmentFromPlatformURL()),
                            {searchResponseId: e} = this.bindings.engine.state.search;
                        return `${t}/admin/#/${r}/search/relevanceInspector/${e}`;
                    }
                };
            s.style =
