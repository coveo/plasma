(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        3122, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
        95153, 97612, 73877, 51843, 96429, 78364, 27682, 36569, 89613, 73492, 17036,
    ],
    {
        13471: function (t, r, e) {
            'use strict';
            (e.r(r),
                e.d(r, {
                    atomic_insight_search_box: function () {
                        return u;
                    },
                }));
            var i = e(5991),
            ...
            var p = function (t, r, e, i) {
                ...
                if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
                    ...
                    for (var s = t.length - 1; s >= 0; s--)
                        (o = t[s]) && (n = (a < 3 ? o(n) : a > 3 ? o(r, e, n) : o(r, e)) || n);
            ...
            let u = class {
                ...
                initialize() {
                    ((this.id = (0, d.r)('atomic-search-box-')),
                        (this.querySetActions = (0, o.b)(this.bindings.engine)));
                    let t = {
                        id: this.id,
                    ...
                    ((this.searchBox = (0, o.G)(this.bindings.engine, {options: t})),
                        (this.searchBoxCommon = new g.S({
                            id: this.id,
                ...
                get suggestions() {
                    var t, r;
                    return null !== (r = null === (t = this.searchBoxState) || void 0 === t ? void 0 : t.suggestions) &&
                        void 0 !== r
                        ? r
                        : [];
                }
                ...
                clearSuggestionElements() {
                    ((this.suggestionElements = []), (this.searchBoxAriaMessage = ''));
                }
                clearSuggestions() {
                ...
                onSuggestionMouseOver(t, r) {
                    (this.updateActiveDescendant(r), t.query && this.updateSuggestedQuery(t.query));
                }
                updateQueryFromSuggestion() {
                    var t;
                    let r = null === (t = this.activeDescendantElement) || void 0 === t ? void 0 : t.getAttribute(g.q);
                    r &&
                        this.searchBoxState.value !== r &&
                        (this.searchBoxCommon.updateQuery(r), this.updateSuggestedQuery(r));
                }
                ...
                updateSuggestionElements() {
                    this.suggestionElements = this.getSuggestionElements(this.suggestions);
                }
                getSuggestionElements(t) {
                    let r = t.map((t) => this.renderSuggestionItem(t)),
                        e = this.numberOfSuggestions + r.filter(m.e).length;
                    return r.slice(0, e);
                }
                onKeyDown(t) {
                ...
                updateAriaMessage() {
                    let t = this.suggestionElements.filter(m.a).length;
                    this.searchBoxAriaMessage = t
                        ? this.bindings.i18n.t('query-suggestions-available', {count: t})
                        : this.bindings.i18n.t('query-suggestions-unavailable');
                }
                async triggerSuggestions() {
                    (this.updateSuggestedQuery(''), this.updateAriaMessage());
                }
                onInput(t) {
                    ((this.isExpanded = !0), this.searchBox.updateText(t), this.triggerSuggestions());
                }
                onFocus() {
                    ((this.isExpanded = !0),
                        this.updateActiveDescendant(),
                ...
                async updateSuggestedQuery(t) {
                    this.suggestedQuery = t;
                }
                renderSuggestion(t, r, e) {
                    let o = `${this.id}-suggestion-${t.key}`,
                        a = o === this.activeDescendant || this.suggestedQuery === t.query;
                    return r === e && t.hideIfLast
                        ? null
                        : (0, i.h)(g.B, {
                              bindings: this.bindings,
                              id: o,
                              ...
                              isDoubleList: !1,
                              onClick: (r) => {
                                  this.searchBoxCommon.onSuggestionClick(t, r);
                              },
                              onMouseOver: () => {
                                  this.onSuggestionMouseOver(t, o);
                              },
                          });
                }
                renderSuggestionItem(t) {
                    let r = '' !== this.searchBox.state.value;
                    return {
                        ...
                        onSelect: () => {
                            this.searchBox.selectSuggestion(t.rawValue);
                        },
                    };
                }
                renderPanel(t, r, e) {
                    return t.length
                        ? (0, i.h)(
                              ...
                              t.map((r, e) => this.renderSuggestion(r, e, t.length - 1)),
                          )
                        : null;
                }
                renderSuggestions() {
                    return this.searchBoxCommon.hasSuggestions
                        ...
                        : (this.updateSuggestedQuery(''), this.updateActiveDescendant(), null);
                }
                componentWillRender() {
