...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [77732],
    {
        77732: function (r, t, e) {
            (e.r(t),
                e.d(t, {
                    atomic_color_facet: function () {
                        return v;
                    },
                }));
            var a = e(5991),
                ...
                w = e(60375),
                g = e(66038);
            (e(2108), e(55294), e(9224), e(47104), e(87856));
            let u = (r, t) => {
                var e;
                let o;
                let i = (0, g.r)('facet-value-'),
                    n = r.numberOfResults.toLocaleString(r.i18n.language),
                    l = r.i18n.t('facet-value', {value: r.displayValue, count: r.numberOfResults}),
                    s =
                        null === (e = r.displayValue.match(RegExp('-?[_a-zA-Z]+[_a-zA-Z0-9-]*'))) || void 0 === e
                            ? void 0
                            : e.toString();
                return (0, a.h)(
                    'li',
                    {key: r.displayValue, class: 'relative flex items-center'},
                    (0, a.h)('button', {
                        id: i,
                        role: 'checkbox',
                        part: `value-checkbox value-${s}${r.isSelected ? ' value-checkbox-checked' : ''}`,
                        onClick: () => r.onClick(),
                        onMouseDown: (r) => (0, w.c)(r, {color: 'neutral', parent: o}),
                        'aria-checked': r.isSelected.toString(),
                        class: `value-checkbox ${r.isSelected ? 'ring-primary' : ''}`,
                        'aria-label': l,
                    }),
                    (0, a.h)(
                        'label',
                        {
                            ...
                            onMouseDown: (r) => (0, w.c)(r, {color: 'neutral'}),
                        },
                        t,
                        (0, a.h)(
                            'span',
                            {part: 'value-count', class: 'value-count'},
                            r.i18n.t('between-parentheses', {text: n}),
                        ),
                    ),
                );
            };
            var b = function (r, t, e, a) {
                var o,
                    i = arguments.length,
                    n = i < 3 ? t : null === a ? (a = Object.getOwnPropertyDescriptor(t, e)) : a;
                if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
                    n = Reflect.decorate(r, t, e, a);
                else
                    for (var l = r.length - 1; l >= 0; l--)
                        (o = r[l]) && (n = (i < 3 ? o(n) : i > 3 ? o(t, e, n) : o(t, e)) || n);
            ...
            let v = class {
                ...
                initialize() {
                    (this.validateProps(),
                        ...
                        (this.facet = (0, o.Z)(this.bindings.engine, {options: this.facetOptions})),
                        (0, h.a)(this.facet, this.label, (r) => (this.facetSearchAriaMessage = r), this.bindings.i18n),
                        (this.facetId = this.facet.state.facetId));
                    let r = {label: () => this.bindings.i18n.t(this.label), facetId: this.facetId, element: this.host};
                    (this.bindings.store.registerFacet('facets', r),
                        (0, m.i)(this.host, {
                            ...r,
                ...
                disconnectedCallback() {
                    ...
                    this.host.isConnected ||
                        null === (r = this.dependenciesManager) ||
                        void 0 === r ||
                        r.stopWatching();
                }
                componentShouldUpdate(r, t, e) {
                    return 'facetState' !== e || !t || !this.withSearch || (0, d.s)(r.facetSearch, t.facetSearch);
                }
                get numberOfSelectedValues() {
                    return this.facetState.values.filter(({state: r}) => 'selected' === r).length;
                }
                initializeDependenciesManager() {
                    this.dependenciesManager = (0, o.S)(this.bindings.engine, {
                        ...
                        return (0, a.h)(c.b, {
                            ...
                            onChange: (r) => {
                                ...
                                (this.facet.facetSearch.updateCaptions((0, n.a)(this.field, this.bindings.i18n)),
                                    this.facet.facetSearch.updateText(r),
                ...
                renderValue(r, t, e, o) {
                    let i = (0, n.g)(this.facetId, r.value, this.bindings.i18n),
                        l = 'selected' === r.state,
                        s = i.replace(/[^a-z0-9]/gi, ''),
                        p = r.value.replace(/[^a-z0-9]/gi, '');
                    switch (this.displayValuesAs) {
                        case 'checkbox':
                            return (0, a.h)(
                                u,
                                {
                                    ...
                                    buttonRef: (r) => {
                                        (e && this.showLessFocus.setTarget(r), o && this.showMoreFocus.setTarget(r));
                                    },
                                },
                                (0, a.h)(d.F, {
                                    displayValue: i,
                        ...
                        case 'box':
                            return (0, a.h)(
                                ...
                                (0, a.h)('div', {
                                    part: `value-${s} value-${p} default-color-value`,
                ...
                renderValuesContainer(r, t) {
                    let e = `mt-3 ${'box' === this.displayValuesAs ? 'box-color-container' : ''}`;
                    return (0, a.h)(
                        d.b,
                        {i18n: this.bindings.i18n, label: this.label, query: t},
                        (0, a.h)('ul', {class: e, part: 'values'}, r),
                    );
                }
                renderValues() {
                    return this.renderValuesContainer(
                        this.facetState.values.map((r, t) =>
                            this.renderValue(
                                r,
                                () => this.facet.toggleSelect(r),
                                0 === t,
                                t === ('automatic' === this.sortCriteria ? 0 : this.resultIndexToFocusOnShowMore),
                            ),
                        ),
                    );
                }
                renderSearchResults() {
                    return this.renderValuesContainer(
                        this.facetState.facetSearch.values.map((r) =>
                            this.renderValue(
                ...
                get facetOptions() {
                    return {
                        ...
                        allowedValues: this.allowedValues.length ? [...this.allowedValues] : void 0,
                        customSort: this.customSort.length ? [...this.customSort] : void 0,
                    };
                }
                render() {
                          ...
                          ? this.facetState.values.length
                              ? (0, a.h)(
                                    ...
                                    !this.isCollapsed && [
                                        ...
                                        (0, d.a)(this.facetState.facetSearch)
                                            ? [this.renderSearchResults(), this.renderMatches()]
                                            : [this.renderValues(), this.renderShowMoreLess()],
                                    ],
                                )
                              : (0, a.h)(l.H, null)
                          : (0, a.h)(p.F, {numberOfValues: this.numberOfValues, isCollapsed: this.isCollapsed});
                }
                get host() {
                    return (0, a.g)(this);
                }
