                ...
                return (t, e) => {
                    ...
                    t.componentWillLoad = function () {
                        ...
                        let c = {
                            ...
                            focus: async () => {
                                (await (0, i.d)(), null == a || a.focus(), null == s || s());
                            },
                            focusAfterSearch: () => (
  ...
  />
        ...
        64346: function (t, e, r) {
            ...
            var m = function (t, e, r, a) {
                ...
                if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
                    ...
                    for (var l = t.length - 1; l >= 0; l--)
                        (i = t[l]) && (n = (o < 3 ? i(n) : o > 3 ? i(e, r, n) : i(e, r)) || n);
            ...
            let g = class {
                ...
                validateProps() {
                    (new i.S({displayValuesAs: new i.a({constrainTo: ['checkbox', 'link']})}).validate({
                        displayValuesAs: this.displayValuesAs,
                    }),
                        (0, d.v)(this.dependsOn));
                }
                initialize() {
                    (this.validateProps(),
                ...
                initializeFacet() {
                    ...
                    ((this.facet = (0, o.l)(this.bindings.engine, {options: t})),
                ...
                initializeDependenciesManager() {
                    this.dependenciesManager = (0, o.S)(this.bindings.engine, {
                        facetId: this.facetId,
                        conditions: (0, d.p)(this.dependsOn),
                    });
                }
                    ...
                    for (let e = this.minValueInIndex; e <= this.numberOfIntervals; e++)
                        t.push(
                            (0, o.h)({
                                ...
                                end: Math.round((e + 1) * this.scaleFactor * 100) / 100,
                                endInclusive: !1,
                            }),
                        );
                    return t;
                ...
                formatFacetValue(t) {
                    return t.start === this.maxValueInIndex
                        ...
                        : this.bindings.i18n.t('stars', {count: t.start, max: this.maxValueInIndex});
                }
                ratingContent(t) {
                    return (0, a.h)(n.R, {
                ...
                renderValues() {
                    return this.renderValuesContainer(
                        this.valuesToRender.map((t) =>
                            this.renderValue(t, () =>
                                'link' === this.displayValuesAs
                                    ? this.facet.toggleSingleSelect(t)
                                    : this.facet.toggleSelect(t),
                            ),
                        ),
                    );
                }
        ...
        11312: function (t, e, r) {
            ...
            function m(t, e, r) {
                return r.t(t, {
                    query: `<span class="font-bold italic text-on-background" part="matches-query">${(0, s.e)(e)}</span>`,
...
`,
                    ...
                    if (t.canShowLessValues || t.canShowMoreValues)
                        return (0, i.h)(
                            ...
                            (0, i.h)(
                                ...
                                (0, i.h)('atomic-icon', {part: 'show-more-less-icon', class: s, icon: f}),
            ...
            class V {
                ...
                componentShouldUpdate(t, e, r) {
                    return 'facetState' !== r || !e || !this.withSearch || (0, s.s)(t, e);
                }
                renderHeader(t, e, r) {
                    return (0, i.h)(s.d, {
                        i18n: this.bindings.i18n,
                        ...
                        case 'checkbox':
                            return (0, i.h)(
                                s.f,
                                {
                                    ...
                                    buttonRef: (t) => {
                                        (r && n.setTarget(t), a && l.setTarget(t));
                                    },
                                },
                                (0, i.h)(s.F, {
                                    displayValue: c,
                    ...
                    return t || !this.facet.state.enabled
                        ...
                        : e
                          ? this.facet.state.values.length
                              ? (0, i.h)(s.c, null, this.renderHeader(o, r, u), !r && this.renderBody(n, d))
                              : (0, i.h)(l.H, null)
            ...
            function n(t) {
                return (e, r) => {
                    ...
                    e.componentWillLoad = function () {
                        ...
                        })(n, l, Array.from(s), null !== (e = null == t ? void 0 : t.splitValues) && void 0 !== e && e),
                            a.call(this));
                    };
                };
            }
