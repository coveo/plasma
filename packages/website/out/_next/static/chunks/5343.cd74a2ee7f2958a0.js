(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        5343, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
    ...
    ],
    {
        6755: function (r, t, o) {
            ...
            let n = class {
                ...
                getTextContent() {
                    return void 0 !== this.field
                        ? (0, e.h)('atomic-result-text', {field: this.field})
                        : void 0 !== this.label
                          ? (0, e.h)('atomic-text', {value: this.label})
                          : (0, e.h)('slot', null);
                }
                renderText() {
                    return (0, e.h)('span', {part: 'result-badge-label'}, this.getTextContent());
                }
                renderBadge() {
                    return (0, e.h)(
                        'div',
                ...
                componentWillRender() {
                    if (this.field) {
                        let r = null !== i.a.getResultProperty(this.result, this.field);
                        r || this.host.remove();
                    }
                }
                render() {
