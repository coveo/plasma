                ...
                s = (e, t, n, a) => {
                    if ((t && 'object' == typeof t) || 'function' == typeof t)
                        for (let r of i(t))
                            o.call(e, r) ||
                                r === n ||
                                m(e, r, {get: () => t[r], enumerable: !(a = l(t, r)) || a.enumerable});
                    return e;
                },
                d = {};
            (s(d, r, 'default'), a && s(a, r, 'default'));
            var c = [
                    'area',
                    'base',
                    'br',
                    ...
                    onEnterRules: [
                        {
                            ...
                            afterText: /^<\/(\w[\w\d]*)\s*>$/i,
                            action: {indentAction: d.languages.IndentAction.IndentOutdent},
                        },
                        {
                            beforeText: RegExp(`<(?!(?:${c.join('|')}))(\\w[\\w\\d]*)([^/>]*(?!/)>)[^<]*$`, 'i'),
                            action: {indentAction: d.languages.IndentAction.Indent},
                        },
                    ],
                },
                h = {
