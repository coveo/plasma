...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [59844],
    {
        59844: function (r, t, o) {
            (o.r(t),
                o.d(t, {
                    atomic_ipx_body: function () {
                        return l;
                    },
                }));
            var i = o(5991),
            ...
            let l = class {
                constructor(r) {
                    ((0, i.r)(this, r),
                        (this.animationEnded = (0, i.c)(this, 'animationEnded', 7)),
                        (this.displayFooterSlot = !0),
                        (this.updateBreakpoints = (0, n.o)(() => (0, a.u)(this.host))));
                }
                componentDidLoad() {
                    let r = this.host.id || (0, n.r)('atomic-ipx-body-');
                    this.host.id = r;
                }
                render() {
                    this.updateBreakpoints();
                    let r = void 0 === this.isOpen;
                    return (0, i.h)(
                        'article',
                        {
                            part: 'container',
                            class: `${r ? '' : this.isOpen ? 'visible' : 'invisible'}`,
          ...
          `,
                        ...
                        (0, i.h)(
                            'header',
                            {part: 'header-wrapper', class: 'flex flex-col items-center'},
                            (0, i.h)('div', {part: 'header'}, (0, i.h)('slot', {name: 'header'})),
                        ),
                        (0, i.h)('hr', {part: 'header-ruler', class: 'border-neutral'}),
                        (0, i.h)(
                            'div',
                            {part: 'body-wrapper', class: 'overflow-auto grow flex flex-col w-full scrollbar'},
                            (0, i.h)('div', {part: 'body', class: 'w-full max-w-lg'}, (0, i.h)('slot', {name: 'body'})),
                        ),
                        this.displayFooterSlot &&
                            (0, i.h)(
                                ...
                                (0, i.h)(
                                    'div',
                                    {part: 'footer', class: 'max-w-lg'},
                                    (0, i.h)('slot', {name: 'footer'}),
                                ),
                            ),
                    );
                }
        ...
        75291: function (r, t, o) {
            ...
            function e(r, t, o, i) {
                let e = (a) => {
                    (r.removeEventListener(t, e, i), 'object' == typeof o ? o.handleEvent.call(r, a) : o.call(r, a));
                };
                ...
                return (t, o) => {
                    ...
                    ((t.componentWillLoad = function () {
                        ...
                        let o = (0, e.b)(l, (t) => {
                            ...
                            try {
                                this.initialize ? (this.initialize(), r && (0, i.f)(this)) : (0, i.f)(this);
                            } catch (r) {
                                this.error = r;
                            }
                        });
                        ...
                        (t.render = function () {
                            return this.error
                                ...
                                : this.bindings
                                  ? ((0, i.g)(this).setAttribute(m, 'true'), w && w.call(this))
                                  : (0, i.h)(n, null);
                        }),
                        (t.disconnectedCallback = function () {
                            let r = (0, i.g)(this);
                            (r.setAttribute(m, 'false'), r.setAttribute(p, 'false'), f(), u && u.call(this));
                        }),
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), c((0, i.g)(this)), b && b.call(this)));
                        }),
        ...
        35295: function (r, t, o) {
            ...
            let e = '1024px';
            function a(r, t) {
                return r.replace(RegExp(`\\(min-width: ${e}\\)`, 'g'), `(min-width: ${t})`);
            }
            let n = ['atomic-search-layout', 'atomic-insight-layout'];
            function l(r) {
                let t = (0, i.c)(r, n.join(', '));
                (null == t ? void 0 : t.mobileBreakpoint) &&
                    t.mobileBreakpoint !== e &&
                    (!(function (r, t) {
                        var o, i;
                        let e = null === (o = r.shadowRoot) || void 0 === o ? void 0 : o.adoptedStyleSheets;
                        if (!e || !e.length) return;
                        let n = e[0],
                            l = Object.values(n.cssRules)
                                .map((r) => r.cssText)
                                .join('');
                        null === (i = n.replaceSync) || void 0 === i || i.call(n, a(l, t));
                    })(r, t.mobileBreakpoint),
                    (function (r, t) {
                        var o;
                        let i = null === (o = r.shadowRoot) || void 0 === o ? void 0 : o.querySelector('style');
                        i && (i.textContent = a(i.textContent, t));
                    })(r, t.mobileBreakpoint));
            }
        },
    },
