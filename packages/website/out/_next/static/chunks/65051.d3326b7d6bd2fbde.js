...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [65051],
    {
        80421: function (r, t, o) {
            ...
            function a(r, t = !1) {
                function o() {
                    let r = (0, e.b)('atomic/accessibility/findAriaLive', {});
                    document.dispatchEvent(r);
                    let {element: t} = r.detail;
                    return t;
                }
                return (e, i) => {
                    let {componentWillRender: a} = e;
                    (Object.defineProperty(e, i, {
                        set: (e) => {
                            var i;
                            null === (i = o()) || void 0 === i || i.updateMessage(r, e, t);
                        },
                    }),
                        (e.componentWillRender = function () {
                            var e;
                            (a && a.call(this), null === (e = o()) || void 0 === e || e.registerRegion(r, t));
                        }));
                };
            }
            function n() {
                return (r, t) => {
                    ...
                    r.componentWillLoad = function () {
                        ...
                        let c = {
                            ...
                            focus: async () => {
                                (await (0, i.d)(), null == e || e.focus(), null == s || s());
                            },
                            focusAfterSearch: () => (
            ...
            function l(r) {
                ...
                return null !==
                    (t = (function* r(t) {
                        ...
                        for (let e of (t instanceof HTMLSlotElement
        ...
        65051: function (r, t, o) {
            (o.r(t),
                o.d(t, {
                    atomic_insight_query_summary: function () {
                        return c;
                    },
                }));
            var e = o(5991),
            ...
            let c = class {
                ...
                initialize() {
                    this.querySummary = (0, i.P)(this.bindings.engine);
                }
                render() {
        ...
        45403: function (r, t, o) {
            ...
            var e = o(5991);
            let i = ({bindings: r, key: t, params: o, count: i}) => {
                let a = (r) => `${r}`,
                    n = (r) => o[r.slice(1)],
                    l = Object.fromEntries(Object.keys(o).map((r) => [r, a(r)])),
                    s = r.i18n.t(t, {interpolation: {escapeValue: !1}, count: i, ...l});
                return (0, e.h)(
                    e.F,
                    null,
        ...
        63654: function (r, t, o) {
            ...
            var e = o(5991),
                i = o(45403);
            let a = (r, t) => (0, e.h)('span', {class: 'font-bold', part: `highlight${r.part ? ` ${r.part}` : ''}`}, t),
                n = (r) => {
                    if (r.querySummaryState.hasError) return;
                    if (!r.querySummaryState.firstSearchExecuted)
                        return (0, e.h)('div', {
                            part: 'placeholder',
                            'aria-hidden': 'true',
                            class: 'h-6 my-2 w-60 bg-neutral rounded animate-pulse',
                        });
                    let t = r.querySummaryState.hasQuery ? 'showing-results-of-with-query' : 'showing-results-of',
                        o = {
                            first: r.querySummaryState.firstResult.toLocaleString(),
                            last: r.querySummaryState.lastResult.toLocaleString(),
                            total: r.querySummaryState.total.toLocaleString(),
                            query: r.querySummaryState.query,
                            count: r.querySummaryState.lastResult,
                        };
                    r.querySummaryState.hasResults &&
                        (r.querySummaryState.isLoading
                            ? r.setAriaLive(r.bindings.i18n.t('loading-results'))
                            : r.setAriaLive(r.bindings.i18n.t(t, o)));
                    let n = {
                        first: (0, e.h)(a, null, o.first),
                        last: (0, e.h)(a, null, o.last),
                        total: (0, e.h)(a, null, o.total),
                        query: (0, e.h)(a, {part: 'query'}, o.query),
                    };
                    return (0, e.h)(
                        'div',
                        {class: 'text-on-background', part: 'container'},
                        r.querySummaryState.hasResults &&
                            (0, e.h)(
                                e.F,
                                null,
                                (0, e.h)(i.L, {key: t, bindings: r.bindings, params: n, count: o.count}),
                                r.querySummaryState.hasDuration &&
                                    (0, e.h)(
                                        'span',
                                        {class: 'hidden', part: 'duration'},
                                        '\xa0',
                                        (0, e.h)(i.L, {
                                            key: 'in-seconds',
                                            bindings: r.bindings,
                                            params: {count: r.querySummaryState.durationInSeconds.toLocaleString()},
                                        }),
                                    ),
                            ),
                    );
