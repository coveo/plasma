...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [79150],
    {
        79150: function (t, r, e) {
            (e.r(r),
                e.d(r, {
                    atomic_segmented_facet: function () {
                        return h;
                    },
                }));
            var a = e(5991),
                ...
                c = e(30257),
                d = e(2108);
            (e(66038), e(87856), e(5812), e(55294), e(9224), e(47104));
            let u = (t) => {
                let r = new Intl.NumberFormat(t.i18n.language, {notation: 'compact'}).format(t.numberOfResults),
                    e = t.numberOfResults.toLocaleString(t.i18n.language),
                    i = t.i18n.t('facet-value', {value: t.displayValue, count: t.numberOfResults});
                return (0, a.h)(
                    'li',
                    {key: t.displayValue},
                    (0, a.h)(
                        d.B,
                        {
                            ...
                            onClick: () => t.onClick(),
                            class: `value-box flex box-border h-full items-center p-2 group ${t.isSelected ? 'selected border-primary shadow-inner-primary' : 'hover:border-primary-light focus-visible:border-primary-light'}`,
                        ...
                        (0, a.h)(
                            'span',
                            {
                                ...
                                part: 'value-label',
                                class: `value-label truncate ${t.isSelected ? 'text-primary' : 'group-hover:text-primary-light group-focus:text-primary'}`,
                            },
                            t.displayValue,
                        ),
                        (0, a.h)(
                            'span',
                            {
                                title: e,
                                part: 'value-count',
                                class: `value-box-count truncate pl-1 w-auto mt-0 text-sm ${t.isSelected ? 'text-primary' : 'text-neutral-dark group-hover:text-primary-light group-focus:text-primary'}`,
                            },
            ...
            var p = function (t, r, e, a) {
                ...
                if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
                    ...
                    for (var l = t.length - 1; l >= 0; l--)
                        (i = t[l]) && (n = (o < 3 ? i(n) : o > 3 ? i(r, e, n) : i(r, e)) || n);
            ...
            let h = class {
                ...
                initialize() {
                    ((this.searchStatus = (0, i.E)(this.bindings.engine)),
                        (this.facet = (0, i.Z)(this.bindings.engine, {options: this.facetOptions})),
                ...
                renderValuesContainer(t) {
                    return (0, a.h)(
                        ...
                        (0, a.h)('ul', {class: 'box-container flex h-10', part: 'values'}, t),
                    );
                }
                renderValue(t, r) {
                    let e = (0, o.g)(this.field, t.value, this.bindings.i18n),
                        i = 'selected' === t.state;
                    return (0, a.h)(u, {
                        displayValue: e,
                ...
                renderValues() {
                    return this.renderValuesContainer(
                        this.facetState.values.map((t) => this.renderValue(t, () => this.facet.toggleSingleSelect(t))),
                    );
                }
                renderLabel() {
                    if (this.label) return (0, a.h)('b', {class: 'mr-2', part: 'label'}, this.label, ':');
                }
                get facetOptions() {
                    return {
                        facetId: this.facetId,
                ...
                render() {
                    return this.searchStatus.state.hasError || !this.facet.state.enabled
                        ? (0, a.h)(n.H, null)
                        : this.searchStatus.state.firstSearchExecuted
                          ? this.facetState.values.length
                              ? (0, a.h)(
                                    'div',
                                    {part: 'segmented-container', class: 'flex whitespace-nowrap h-10 items-center'},
                                    this.renderLabel(),
                                    this.renderValues(),
                                )
                              : (0, a.h)(n.H, null)
        ...
        11312: function (t, r, e) {
            ...
            let h = (t) => {
                ...
                let e = t.i18n.t(t.label),
                    ...
                    o = t.i18n.t('facet-search', {label: e}),
                    n = t.i18n.t('clear');
                return (0, i.h)(
                    'div',
                    ...
                    (0, i.h)(
                        ...
                        (0, i.h)('input', {
                            ...
                            'aria-label': o,
                            value: t.query,
                            onInput: (r) => t.onChange(r.target.value),
                            ref: (t) => (r = t),
                        }),
                        (0, i.h)(
                            'div',
            ...
            function m(t, r, e) {
                return e.t(t, {
                    query: `<span class="font-bold italic text-on-background" part="matches-query">${(0, s.e)(r)}</span>`,
...
`,
                f = (t) => {
                    let r = t.i18n.t(t.label),
                        e = t.i18n.t('show-more'),
                        a = t.i18n.t('show-more-facet-values', {label: r}),
                        o = t.i18n.t('show-less'),
                        n = t.i18n.t('show-less-facet-values', {label: r}),
                        ...
                        return (0, i.h)(
                            ...
                            (0, i.h)(
                                p.B,
                                {
                                    style: 'text-primary',
                                    part: 'show-less',
                                    class: `${l} ${t.canShowLessValues ? '' : 'hidden'}`,
                                    ariaLabel: n,
                            ...
                            (0, i.h)(
                                p.B,
                                {
                                    style: 'text-primary',
                                    part: 'show-more',
                                    class: `${l} ${t.canShowMoreValues ? '' : 'hidden'}`,
                                    ariaLabel: a,
                                    onClick: () => t.onShowMore(),
                                    ref: t.showMoreRef,
                                },
                                (0, i.h)('atomic-icon', {part: 'show-more-less-icon', class: s, icon: w}),
                                (0, i.h)('span', {class: 'truncate'}, e),
                            ),
                        );
                },
                b = (t, r) => {
                    let e = new Intl.NumberFormat(t.i18n.language, {notation: 'compact'}).format(t.numberOfResults),
                    ...
                    return (0, i.h)(
                        ...
                        (0, i.h)(
                            ...
                            (0, i.h)(
                                ...
                                t.i18n.t('between-parentheses', {text: e}),
                            ),
                        ),
                    );
                },
            ...
            function k(t) {
                let {hasInput: r, hasInputRange: e, searchStatusState: a, facetValues: i} = t;
                if (!r) return !1;
                if (e) return !0;
            ...
            class V {
                ...
                componentShouldUpdate(t, r, e) {
                    return 'facetState' !== e || !r || !this.withSearch || (0, s.s)(t, r);
                }
                renderHeader(t, r, e) {
                    return (0, i.h)(s.d, {
                        i18n: this.bindings.i18n,
                ...
                renderValuesContainer(t, r) {
                    let e = `mt-3 ${'box' === this.displayValuesAs ? 'box-container' : ''}`;
                    return (0, i.h)(
                        s.b,
                        {i18n: this.bindings.i18n, label: this.label, query: r},
                        (0, i.h)('ul', {class: e, part: 'values'}, t),
                    );
                }
                renderSearchResults(t, r) {
                    return this.renderValuesContainer(
                        this.facet.state.facetSearch.values.map((e) =>
                            this.renderValue(
                                {state: 'idle', numberOfResults: e.count, value: e.rawValue},
                                () =>
                                    'link' === this.displayValuesAs
                                        ? this.facet.facetSearch.singleSelect(e)
                                        : this.facet.facetSearch.select(e),
                                !1,
                                !1,
                                t,
                                r,
                ...
                renderValues(t, r) {
                    return this.renderValuesContainer(
                        this.facet.state.values.map((e, a) =>
                            this.renderValue(
                                e,
                                () =>
                                    'link' === this.displayValuesAs
                                        ? this.facet.toggleSingleSelect(e)
                                        : this.facet.toggleSelect(e),
                                0 === a,
                        ...
                        case 'checkbox':
                            return (0, i.h)(
                                s.f,
                                {
                                    ...
                                    buttonRef: (t) => {
                                        (e && n.setTarget(t), a && l.setTarget(t));
                                    },
                                },
                                (0, i.h)(s.F, {
                                    displayValue: c,
                ...
                renderBody(t, r) {
                    return [
                        ...
                        (0, s.a)(this.facet.state.facetSearch)
                            ? [this.renderSearchResults(t, r), this.renderMatches()]
                            : [this.renderValues(t, r), this.renderShowMoreLess(t, r)],
                    ];
                }
                render({
                    hasError: t,
                    firstSearchExecuted: r,
                    isCollapsed: e,
                    numberOfValues: a,
                    headerFocus: o,
                    showLessFocus: n,
                    ...
                    return t || !this.facet.state.enabled
                        ...
                        : r
                          ? this.facet.state.values.length
                              ? (0, i.h)(s.c, null, this.renderHeader(o, e, u), !e && this.renderBody(n, d))
                              : (0, i.h)(l.H, null)
                          : (0, i.h)(c.F, {numberOfValues: a, isCollapsed: e});
                }
            }
        },
        5812: function (t, r, e) {
            ...
            var a = e(5991),
                i = e(66038);
            let o = ({numberOfValues: t, isCollapsed: r}) => {
                let e = [];
                for (let r = 0; r < t; r++) {
                    let t = `${(0, i.g)(60, 100)}%`,
                        r = `${(0, i.g)(0.3, 1)}`;
                    e.push((0, a.h)('div', {class: 'flex bg-neutral h-5 mt-4', style: {width: t, opacity: r}}));
                }
                return (0, a.h)(
                    'div',
                    {
                    ...
                    !r && (0, a.h)('div', {class: 'mt-7'}, e),
                );
            };
        },
        88780: function (t, r, e) {
            e.d(r, {
                i: function () {
                    return o;
                },
            ...
            function o(t, r) {
                t.dispatchEvent((0, a.b)('atomic/initializePopover', r));
            }
        },
        53049: function (t, r, e) {
            e.d(r, {
                A: function () {
                    return l;
                },
            ...
            function n(t) {
                return (r, e) => {
                    ...
                    r.componentWillLoad = function () {
                                    ...
                                    ? Object.entries(i).reduce(
                                          (t, [r, e]) => ({
                                              ...
                                              [r]: (function (t) {
                                                  var r;
                                                  let [...e] =
                                                          null !== (r = t.matchAll(/(?:\\.|[^,])+/g)) && void 0 !== r
                                                              ? r
                                                              : [],
                                                      a = /\\(.)/g;
                                                  return e.map(([t]) => t.replace(a, '$1'));
                                              })(e).map((t) => t.trim()),
                                          }),
                                          {},
                                      )
                        ...
                        })(n, l, Array.from(s), null !== (r = null == t ? void 0 : t.splitValues) && void 0 !== r && r),
                            a.call(this));
                    };
                };
            }
