(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        25434, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
    ...
    ],
    {
        81382: function (t, r, e) {
            ...
            (e.r(r),
                e.d(r, {
                    atomic_results_per_page: function () {
                        return d;
                    },
                }));
            var i = e(5991),
            ...
            let d = class {
                constructor(t) {
                    ((0, i.r)(this, t),
                        (this.scrollToTopEvent = (0, i.c)(this, 'atomic/scrollToTop', 7)),
                        (this.radioGroupName = (0, n.r)('atomic-results-per-page-')),
                ...
                initialize() {
                    ((this.choices = this.validateChoicesDisplayed()),
                        ...
                        (this.resultPerPage = (0, o.f)(this.bindings.engine, {
                            initialState: {numberOfResults: this.initialChoice},
                        })));
                }
                validateChoicesDisplayed() {
                    return this.choicesDisplayed.split(',').map((t) => {
                        let r = parseInt(t);
                        if (isNaN(r)) {
                            let r = `The choice value "${t}" from the "choicesDisplayed" option is not a number.`;
                            throw (this.bindings.engine.logger.error(r, this), Error(r));
                        }
                        return r;
                    });
                }
                validateInitialChoice() {
                    ...
                    if (!this.choices.includes(this.initialChoice)) {
                        let t = `The "initialChoice" option value "${this.initialChoice}" is not included in the "choicesDisplayed" option "${this.choicesDisplayed}".`;
                        throw (this.bindings.engine.logger.error(t, this), Error(t));
                    }
                }
                buildChoice(t) {
                    let r = this.resultPerPage.isSetTo(t),
                        e = ['button'];
                    r && e.push('active-button');
                    let o = t.toLocaleString(this.bindings.i18n.language);
                    return (0, i.h)(s.R, {
                        key: t,
                        ...
                        ariaLabel: o,
                        onChecked: () => {
                            (this.focusOnProperResultDependingOnChoice(t), this.resultPerPage.set(t));
                        },
                ...
                focusOnProperResultDependingOnChoice(t) {
                    var r, e;
                    t < this.resultPerPageState.numberOfResults
                        ? null === (r = this.bindings.store.state.resultList) ||
                          void 0 === r ||
                          r.focusOnFirstResultAfterNextSearch().then(() => this.scrollToTopEvent.emit())
                        : t > this.resultPerPageState.numberOfResults &&
                          (null === (e = this.bindings.store.state.resultList) ||
                              void 0 === e ||
                              e.focusOnNextNewResult());
                }
                render() {
                    if (!this.bindings.store.isAppLoaded() || !this.searchStatusState.hasResults) return;
                    let t = this.bindings.i18n.t('results-per-page');
                    return (0, i.h)(
                        'div',
                        ...
                        (0, i.h)(
                            ...
                            (0, i.h)(
                                ...
                                this.choices.map((t) => this.buildChoice(t)),
                            ),
                        ),
                    );
                }
        ...
        12634: function (t, r, e) {
            ...
            let n = (t) => {
                ...
                if (t.style) {
                    let r = (0, a.g)(t.style);
                    (n.push((0, a.a)(t.style)), (e = (t) => (0, o.c)(t, {color: r})));
                }
                (t.checked && n.push('selected'), t.class && n.push(t.class));
                let l = {
                    name: t.groupName,
                    key: t.key,
                    checked: t.checked,
                    class: n.join(' '),
                    part: t.part,
                    'aria-label': null !== (r = t.ariaLabel) && void 0 !== r ? r : t.text,
                ...
                return (0, i.h)('input', {
                    ...
                    onChange: (r) => {
                        var e;
                        return (
                            r.currentTarget.checked && (null === (e = t.onChecked) || void 0 === e ? void 0 : e.call(t))
                        );
                    },
                    onMouseDown: e,
                    ...l,
