(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        47590, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
        95153, 97612, 73877, 51843, 96429, 78364, 27682, 36569, 89613, 73492, 17036,
    ],
    {
        44871: function (r, t, e) {
            'use strict';
            (e.r(t),
                e.d(t, {
                    atomic_insight_tab: function () {
                        return d;
                    },
                }));
            var o = e(5991),
                ...
                s = e(35634);
            e(87856);
            var c = function (r, t, e, o) {
                var i,
                    a = arguments.length,
                    n = a < 3 ? t : null === o ? (o = Object.getOwnPropertyDescriptor(t, e)) : o;
                if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
                    n = Reflect.decorate(r, t, e, o);
                else
                    for (var l = r.length - 1; l >= 0; l--)
                        (i = r[l]) && (n = (a < 3 ? i(n) : a > 3 ? i(t, e, n) : i(t, e)) || n);
                return (a > 3 && n && Object.defineProperty(t, e, n), n);
            };
            let d = class {
                constructor(r) {
                    ((0, o.r)(this, r),
                        (this.tabId = (0, n.r)('insight-tab')),
                        (this.label = 'no-label'),
                        (this.active = !1),
                        (this.unsubscribe = () => {}));
                }
                ...
                initialize() {
                    ((this.tab = (0, i.o)(this.bindings.engine, {
                        options: {expression: this.expression, id: this.tabId},
                        initialState: {isActive: this.active},
                    })),
                        (this.unsubscribe = this.tab.subscribe(() => (this.active = this.tab.state.isActive))));
                }
                componentDidRender() {
                    (0, s.d)(this.host);
                }
                ...
                render() {
                    if (!this.bindings.store.isAppLoaded()) return;
                    let r = ['relative', 'pb-3', 'mt-1', 'mr-6', 'font-semibold'];
                    return (
                        this.tabState.isActive && r.push('active'),
                        (0, o.h)(
                            l.B,
                            {
            ...
            let n = (r, t) => {
                let e = (0, a.g)(r.style),
                    ...
                    l = {
                        ...
                        ref(t) {
                            var e;
                            (r.form && (null == t || t.setAttribute('form', r.form)),
                                r.ariaHidden && (null == t || t.setAttribute('aria-hidden', r.ariaHidden)),
                                r.tabIndex && (null == t || t.setAttribute('tabindex', r.tabIndex)),
                                null === (e = r.ref) || void 0 === e || e.call(r, t));
                        },
                    };
                return (0, o.h)(
                    'button',
                    {...l, onMouseDown: (r) => (0, i.c)(r, {color: e})},
                    r.text ? (0, o.h)('span', {class: 'truncate'}, r.text) : null,
                    t,
                );
            };
        },
        35126: function (r, t, e) {
            'use strict';
            function o(r) {
                switch (r) {
                    case 'primary':
        ...
        75291: function (r, t, e) {
            ...
            function i(r, t, e, o) {
                let i = (a) => {
                    (r.removeEventListener(t, i, o), 'object' == typeof e ? e.handleEvent.call(r, a) : e.call(r, a));
                };
                ...
                return (t, e) => {
                    ...
                    ((t.componentWillLoad = function () {
                        ...
                        let e = (0, i.b)(l, (t) => {
                            ...
                            try {
                                this.initialize ? (this.initialize(), r && (0, o.f)(this)) : (0, o.f)(this);
                            } catch (r) {
                                this.error = r;
                            }
                        });
                        if ((t.dispatchEvent(e), !(0, a.c)(t, s.join(', ')))) {
                        ...
                        (t.render = function () {
                            return this.error
                                ...
                                : this.bindings
                                  ? ((0, o.g)(this).setAttribute(m, 'true'), w && w.call(this))
                                  : (0, o.h)(n, null);
                        }),
                        (t.disconnectedCallback = function () {
                            let r = (0, o.g)(this);
                            (r.setAttribute(m, 'false'), r.setAttribute(p, 'false'), f(), h && h.call(this));
                        }),
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), d((0, o.g)(this)), b && b.call(this)));
                        }),
        ...
        60375: function (r, t, e) {
            ...
            let i = 'ripple';
            function a(r) {
                'static' === getComputedStyle(r).position && r.classList.add('ripple-relative');
            }
            function n(r, t) {
                var e;
                let o = null !== (e = t.parent) && void 0 !== e ? e : r.currentTarget,
                    n = o.getElementsByClassName(i)[0];
                (n && n.remove(), o.classList.add('ripple-parent'), a(o), Array.from(o.children).forEach(a));
                let s = document.createElement('span');
                (s.classList.add(i), (s.style.backgroundColor = `var(--atomic-${t.color})`), s.setAttribute('part', i));
                let c = Math.max(o.clientWidth, o.clientHeight),
                    d = c / 2,
                    m = 129.21 * Math.cbrt(d),
                    {top: p, left: g} = o.getBoundingClientRect();
                ((s.style.width = s.style.height = `${c}px`),
                    (s.style.left = `${r.clientX - (g + d)}px`),
                    (s.style.top = `${r.clientY - (p + d)}px`),
                    s.style.setProperty('--animation-duration', `${m}ms`),
                    o.prepend(s),
                    l(s, m));
            }
            async function l(r, t) {
                ((0, o.l)(r, 'animationend', () => {
                    r && r.remove();
                }),
                    setTimeout(() => (null == r ? void 0 : r.remove()), t + 0.1 * t));
            }
        },
        35634: function (r, t, e) {
            'use strict';
            e.d(t, {
                d: function () {
                    return i;
            ...
            var o = e(75291);
            let i = (r) => {
                let t = (0, o.b)('atomic/tabRendered', {});
                r.dispatchEvent(t);
            };
        },
        22029: function (r) {
