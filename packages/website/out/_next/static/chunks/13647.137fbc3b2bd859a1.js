(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        13647, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
        95153, 97612, 73877, 51843, 96429, 78364, 27682, 36569, 89613, 73492, 17036,
    ],
    {
        42352: function (r, t, o) {
            'use strict';
            (o.r(t),
                o.d(t, {
                    atomic_popover: function () {
                        return p;
                    },
                }));
            var e = o(5991),
            ...
            let p = class {
                constructor(r) {
                    ((0, e.r)(this, r), (this.isOpen = !1));
                }
                initialize() {
                    if (((this.searchStatus = (0, i.E)(this.bindings.engine)), 0 === this.host.children.length)) {
                        this.error = Error('One child is required inside a set of popover tags.');
                        return;
                    }
                    this.host.children.length > 1 &&
                        (this.error = Error('Cannot have more than one child inside a set of popover tags.'));
                }
                initializePopover(r) {
                    !this.childFacet &&
                        r.detail &&
                        ((this.childFacet = r.detail), this.childFacet.element.classList.add(s.p));
                }
                handleKeyDown(r) {
                    'Escape' === r.key && this.isOpen && this.togglePopover();
                }
                get popoverId() {
                    var r;
                    return `${null === (r = this.childFacet) || void 0 === r ? void 0 : r.facetId}-popover`;
                }
                get label() {
                ...
                componentDidRender() {
                    !this.popperInstance &&
                        this.buttonRef &&
                        this.popupRef &&
                        (this.popperInstance = (0, d.c)(this.buttonRef, this.popupRef, {
                ...
                componentDidUpdate() {
                    var r;
                    null === (r = this.popperInstance) || void 0 === r || r.forceUpdate();
                }
                renderDropdownButton() {
                    let r = this.label,
                        t = !!this.childFacet.numberOfSelectedValues(),
                        o = this.childFacet.numberOfSelectedValues().toLocaleString(),
                        i = this.bindings.i18n.t('popover', {label: r});
                    return (0, e.h)(
                        l.B,
                        {
                            ...
                            class: `rounded flex box-border h-full items-center min-w-[6rem] max-w-[15rem] p-2.5 group hover:border-primary-light focus-visible:border-primary-light ${this.isOpen ? 'border-primary ring ring-ring-primary text-primary z-[9999]' : ''}`,
                        },
                        (0, e.h)(
                            'span',
                            {
                                title: r,
                                part: 'value-label',
                                class: `truncate mr-1.5 ${this.isOpen ? '' : 'group-hover:text-primary-light group-focus:text-primary'}`,
                            },
                            r,
                        ),
                        (0, e.h)(
                            ...
                            {
                                part: 'value-count',
                                class: `truncate mr-1.5 text-sm group-hover:text-primary-light group-focus:text-primary ${t ? '' : 'hidden'} ${this.isOpen ? 'text-primary' : 'text-neutral-dark'}`,
                            },
                            this.bindings.i18n.t('between-parentheses', {text: o}),
                        ),
                        (0, e.h)('atomic-icon', {
                            part: 'arrow-icon',
                            class: `w-2 ml-auto group-hover:text-primary-light group-focus:text-primary ${this.isOpen ? 'rotate-180' : ''} `,
                            icon: a.A,
                        }),
                    );
                }
                ...
                renderPopover() {
                    return (0, e.h)(
                        'div',
                        {class: `relative ${this.isOpen ? 'z-[9999]' : ''}`},
                    ...
                    return this.searchStatus.state.hasError
                        ...
                        : this.searchStatus.state.firstSearchExecuted
                          ? this.searchStatus.state.hasResults &&
                            (null === (r = this.childFacet) || void 0 === r ? void 0 : r.hasValues())
                              ? (0, e.h)(
                                    e.H,
                                    null,
                                    (0, e.h)(
            ...
            (c([(0, n.I)()], p.prototype, 'bindings', void 0),
                c([(0, n.B)('searchStatus')], p.prototype, 'searchStatusState', void 0),
                c([(0, n.B)('facet')], p.prototype, 'facetState', void 0),
                (p.style =
        ...
        88780: function (r, t, o) {
            ...
            function a(r, t) {
                r.dispatchEvent((0, e.b)('atomic/initializePopover', t));
            }
        },
        22029: function (r) {
            function t(r) {
