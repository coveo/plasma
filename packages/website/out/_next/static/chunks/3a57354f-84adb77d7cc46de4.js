            ...
            var t = a(76795),
                ...
                d = {
                    ...
                    date: {
                        ...
                        weekday: {
                            wide: ['יום ראשון', 'יום שני', 'יום שלישי', 'יום רביעי', 'יום חמישי', 'יום שישי', 'שבת'],
                            abbr: ['יום א׳', 'יום ב׳', 'יום ג׳', 'יום ד׳', 'יום ה׳', 'יום ו׳', 'שבת'],
                        },
                    },
                    location: {
                        building_number: ['###', '##', '#', "'ב##", "'א##", "'א#", "'ב#"],
                        city_name: [
                            'אבו גוש',
                            'אבו סנאן',
                            'אבו סריחאן (שבט)',
                        ...
                        county: ['Not relevant for Israel'],
                        default_country: ['ישראל'],
                        direction: ['צפון', 'מזרח', 'דרום', 'מערב', 'צפון מזרח', 'צפון מערב', 'דרום מזרח', 'דרום מערב'],
                        direction_abbr: ['צ', 'מז', 'ד', 'מע', 'צ-מז', 'צ-מע', 'ד-מז', 'ד-מע'],
                        postcode: ['#####', '#######'],
                        secondary_address: ['# דירה', '## דירה', '# חדר', '## חדר'],
                        state: ['חיפה', 'תל אביב', 'הגדה המערבית', 'צפון', 'דרום', 'ירושלים', 'מרכז'],
                        state_abbr: [
                            'AL',
                            'AK',
                            'AZ',
                        ...
                        street_name: i,
                        street_pattern: ['{{location.street_prefix}} {{location.street_name}}'],
                        street_prefix: ['רחוב', 'שדרות', 'משעול', 'דרך', 'סמטת'],
                    },
                    lorem: {
                        supplemental: [
                            'abbas',
                    ...
                    person: {
                        ...
                        last_name_pattern: [{value: '{{person.last_name}}', weight: 1}],
                        male_first_name: c,
                        male_prefix: l,
                        name: [
