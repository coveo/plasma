...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [65116],
    {
        65116: function (r, t, o) {
            (o.r(t),
                o.d(t, {
                    atomic_result_fields_list: function () {
                        return a;
                    },
                }));
            var i = o(5991),
            ...
            let a = class {
                constructor(r) {
                    ((0, i.r)(this, r), (this.updatingChildren = !1), (this.rows = []));
                }
                connectedCallback() {
                ...
                get isOverflowing() {
                    return (
                        this.host.scrollWidth > this.host.clientWidth || this.host.scrollHeight > this.host.clientHeight
                    );
                }
                getSortedChildrenBySize() {
                    return this.children.sort((r, t) => r.offsetWidth - t.offsetWidth);
                }
                hide(r) {
                ...
                setHideDivider(r, t) {
                    r.classList.toggle('hide-divider', t);
                }
                showChildren() {
                    this.children.forEach((r) => this.show(r));
                }
                showDividers() {
                    this.children.forEach((r) => this.setHideDivider(r, !1));
                }
                hideChildrenToFit() {
                    let r = this.getSortedChildrenBySize();
                    for (let t = r.length - 1; this.isOverflowing && t >= 0; t--) this.hide(r[t]);
                }
                hideDividersAtEndOfRows() {
                    this.rows = [];
                    let r = null;
                    (this.children
                        .filter((r) => !this.isChildHidden(r))
                        .forEach((t) => {
                            let o = t.offsetTop;
                            (-1 === this.rows.indexOf(o) && (this.rows.push(o), r && this.setHideDivider(r, !0)),
                                (r = t));
                        }),
                        r && this.setHideDivider(r, !0));
                }
                render() {
                    return (0, i.h)(i.H, null);
                }
                get host() {
                    return (0, i.g)(this);
                }
        ...
        18043: function (r, t, o) {
            ...
            function n(r = {folded: !1}) {
                return (t, o) => {
                    let {connectedCallback: n, componentWillRender: l, render: d} = t;
            ...
            let s = 'atomic/resolveResult',
                d = 'atomic/resolveInteractiveResult';
            function c(r) {
            ...
            function m() {
                return (r, t) => {
                    ...
                    r.componentWillRender = function () {
                        let r = (0, i.g)(this),
                            a = (0, e.b)('atomic/resolveChildTemplates', (r) => {
            ...
            function p() {
                return (r, t) => {
                    ...
                    r.componentWillRender = function () {
                        let r = (0, i.g)(this),
                            a = (0, e.b)('atomic/resolveResultDisplayConfig', (r) => {
                                this[t] = r;
                            }),
                            n = r.dispatchEvent(a);
