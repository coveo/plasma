...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [53023],
    {
        53023: function (r, t, o) {
            (o.r(t),
                o.d(t, {
                    atomic_insight_edit_toggle: function () {
                        return n;
                    },
                }));
            var a = o(5991),
                e = o(45584);
            o(2108);
            let i = `<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.80533 10.547L6.34412 10.3539C6.25831 10.5589 6.31805 10.7958 6.49074 10.9356C6.66344 11.0754 6.90766 11.0845 7.09024 10.9579L6.80533 10.547ZM7.42452 10.1176L7.1396 9.70675L7.42452 10.1176ZM7.09291 9.86009L7.55412 10.0532L7.09291 9.86009ZM7.63231 9.92488L12.1735 4.51291L11.4075 3.87012L6.86627 9.28209L7.63231 9.92488ZM11.7905 4.1915L7.23771 9.61727L8.00375 10.2601L12.5565 4.83429L11.7905 4.1915ZM7.1396 9.70675L6.52041 10.1361L7.09024 10.9579L7.70943 10.5285L7.1396 9.70675ZM7.26654 10.7401L7.55412 10.0532L6.6317 9.667L6.34412 10.3539L7.26654 10.7401ZM7.23771 9.61727C7.20913 9.65133 7.17614 9.68142 7.1396 9.70675L7.70943 10.5285C7.81904 10.4525 7.91802 10.3622 8.00375 10.2601L7.23771 9.61727ZM11.8213 4.54372C11.7155 4.45497 11.7017 4.29728 11.7905 4.1915L12.5565 4.83429C12.8228 4.51699 12.7814 4.04393 12.4641 3.77768L11.8213 4.54372ZM12.1735 4.51291C12.0848 4.61868 11.9271 4.63248 11.8213 4.54372L12.4641 3.77768C12.1468 3.51143 11.6737 3.55282 11.4075 3.87012L12.1735 4.51291ZM6.86627 9.28209C6.76914 9.39785 6.69005 9.52762 6.6317 9.667L7.55412 10.0532C7.57357 10.0067 7.59993 9.96347 7.63231 9.92488L6.86627 9.28209Z" fill="currentColor"/>
<path d="M0.500009 11.5H1.00001H0.500009ZM0.5 1.5H0V1.5L0.5 1.5ZM11 8.89473C11 8.61859 10.7762 8.39473 10.5 8.39473C10.2239 8.39473 10 8.61859 10 8.89473H11ZM10 3C10 3.27614 10.2239 3.5 10.5 3.5C10.7762 3.5 11 3.27614 11 3H10ZM9.50001 12H1.50001V13H9.50001V12ZM1.00001 11.5L1 1.5L0 1.5L8.82149e-06 11.5H1.00001ZM1.5 1H9.50001V0H1.5V1ZM10 8.89473V11.5H11V8.89473H10ZM10 1.5V3H11V1.5H10ZM9.50001 1C9.77615 1 10 1.22386 10 1.5H11C11 0.671572 10.3284 0 9.50001 0V1ZM1.50001 12C1.22387 12 1.00001 11.7761 1.00001 11.5H8.82149e-06C9.47714e-06 12.3284 0.671582 13 1.50001 13V12ZM9.50001 13C10.3284 13 11 12.3284 11 11.5H10C10 11.7761 9.77615 12 9.50001 12V13ZM1 1.5C1 1.22386 1.22386 1 1.5 1V0C0.671573 0 0 0.671574 0 1.5H1Z" fill="currentColor"/>
...
`,
                n = class {
                    constructor(r) {
                        ((0, a.r)(this, r), (this.clickCallback = () => {}), (this.tooltip = ''));
                    }
                    render() {
                        return (0, a.h)(e.I, {
                    ...
                    l = {
                        ...
                        ref(t) {
                            ...
                            (r.form && (null == t || t.setAttribute('form', r.form)),
                                ...
                                null === (o = r.ref) || void 0 === o || o.call(r, t));
                        },
                    };
                return (0, a.h)(
                    'button',
                    {...l, onMouseDown: (r) => (0, e.c)(r, {color: o})},
                    r.text ? (0, a.h)('span', {class: 'truncate'}, r.text) : null,
                    t,
                );
            };
        },
        35126: function (r, t, o) {
            function a(r) {
                switch (r) {
                    case 'primary':
                        return 'btn-primary';
        ...
        75291: function (r, t, o) {
            ...
            function e(r, t, o, a) {
                let e = (i) => {
                    (r.removeEventListener(t, e, a), 'object' == typeof o ? o.handleEvent.call(r, i) : o.call(r, i));
                };
                r.addEventListener(t, e, a);
            }
            o.d(t, {
                b: function () {
                    return a;
        ...
        45584: function (r, t, o) {
            ...
            let i = (r) =>
                (0, a.h)(
                    'div',
                    {class: 'relative', part: `${r.partPrefix}-container`},
                    (0, a.h)(
                        e.B,
                        {
                            ...r,
                            class: 'p-3 relative w-[2.6rem] h-[2.6rem]',
                            part: `${r.partPrefix}-button`,
                            ref: r.buttonRef,
                        },
                        (0, a.h)('atomic-icon', {
                            icon: r.icon,
                            class: 'w-4 h-4 shrink-0',
                            part: `${r.partPrefix}-icon`,
                        }),
                    ),
                    r.badge &&
                        (0, a.h)(
        ...
        60375: function (r, t, o) {
            ...
            function n(r, t) {
                var o;
                let a = null !== (o = t.parent) && void 0 !== o ? o : r.currentTarget,
                    n = a.getElementsByClassName(e)[0];
                (n && n.remove(), a.classList.add('ripple-parent'), i(a), Array.from(a.children).forEach(i));
                let s = document.createElement('span');
                (s.classList.add(e), (s.style.backgroundColor = `var(--atomic-${t.color})`), s.setAttribute('part', e));
                let c = Math.max(a.clientWidth, a.clientHeight),
                    d = c / 2,
                    m = 129.21 * Math.cbrt(d),
                    {top: p, left: g} = a.getBoundingClientRect();
