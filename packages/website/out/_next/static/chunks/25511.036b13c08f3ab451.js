...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [25511],
    {
        25511: function (t, r, o) {
            (o.r(r),
                o.d(r, {
                    atomic_ipx_button: function () {
                        return c;
                    },
                }));
            var e = o(5991),
                ...
                l = o(2108);
            (o(66038), o(87856));
            let s = new RegExp(/^(?=.*(?:\d+|px)$).*$/),
                c = class {
                    constructor(t) {
                        ((0, e.r)(this, t), (this.closeIcon = i.C), (this.openIcon = a.S), (this.isModalOpen = !1));
                    }
                    async onClick() {
                        (this.isModalOpen ? this.close() : this.open(), this.render());
                    }
                    renderIPXButton() {
                        return (0, e.h)(
                            l.B,
                            {style: 'primary', part: 'ipx-button', class: 'my-2', onClick: () => this.onClick()},
                            (0, e.h)(
                                'span',
                                {part: 'button-icon'},
                                (0, e.h)('atomic-icon', {part: 'ipx-close-icon', icon: this.getIcon(this.closeIcon)}),
                                (0, e.h)('atomic-icon', {part: 'ipx-open-icon', icon: this.getIcon(this.openIcon)}),
                            ),
                            (0, e.h)('span', {part: 'button-text'}, this.label),
                        );
                    }
                    render() {
                        let [t, r] = this.isModalOpen
              ...
              .btn-open {
                ...
                [part=${r}] {
                  transform: translateY(0rem);
                            ...
                            (0, e.h)(
                                'div',
                                {class: 'flex flex-col items-center', part: 'container'},
                    ...
                    getIcon(t) {
                        ...
                        if (!o) return r.innerHTML;
                        let e = this.getIconWidth(o),
                            i = this.getIconHeight(o);
                        return (
                            this.cleanupSVGStyles(o),
                            e && i && o.setAttribute('viewBox', `0 0 ${e} ${i}`),
                            r.innerHTML
                        );
                    }
                    cleanupSVGStyles(t) {
                        (t.removeAttribute('style'), t.removeAttribute('width'), t.removeAttribute('height'));
                    }
                    getIconWidth(t) {
                        var r;
                        let o = null !== (r = t.getAttribute('width')) && void 0 !== r ? r : '';
                        return s.test(o) ? o : null;
                    }
                    getIconHeight(t) {
                        var r;
                        let o = null !== (r = t.getAttribute('height')) && void 0 !== r ? r : '';
                        return s.test(o) ? o : null;
                    }
                    get host() {
                        return (0, e.g)(this);
                    ...
                    l = {
                        ...
                        ref(r) {
                            ...
                            (t.form && (null == r || r.setAttribute('form', t.form)),
                                ...
                                null === (o = t.ref) || void 0 === o || o.call(t, r));
                        },
                    };
                return (0, e.h)(
                    'button',
                    {...l, onMouseDown: (t) => (0, i.c)(t, {color: o})},
                    t.text ? (0, e.h)('span', {class: 'truncate'}, t.text) : null,
                    r,
                );
            };
        },
        35126: function (t, r, o) {
            function e(t) {
                switch (t) {
                    case 'primary':
                        return 'btn-primary';
        ...
        75291: function (t, r, o) {
            function e(t, r) {
                return new CustomEvent(t, {detail: r, bubbles: !0, cancelable: !0, composed: !0});
            }
            function i(t, r, o, e) {
                let i = (a) => {
                    (t.removeEventListener(r, i, e), 'object' == typeof o ? o.handleEvent.call(t, a) : o.call(t, a));
                };
                ...
                return (r, o) => {
                    ...
                    ((r.componentWillLoad = function () {
                        ...
                        let o = (0, i.b)(l, (r) => {
                            ...
                            try {
                                this.initialize ? (this.initialize(), t && (0, e.f)(this)) : (0, e.f)(this);
                            } catch (t) {
                                this.error = t;
                            }
                        });
                        if ((r.dispatchEvent(o), !(0, a.c)(r, s.join(', ')))) {
                        ...
                        (r.render = function () {
                            return this.error
                                ...
                                : this.bindings
                                  ? ((0, e.g)(this).setAttribute(p, 'true'), w && w.call(this))
                                  : (0, e.h)(n, null);
                        }),
                        ...
                        (r.componentDidRender = function () {
                            ...
                            'false' !== t.getAttribute(p) &&
                                ...
                                'false' === t.getAttribute(m) &&
                                    (t.setAttribute(m, 'true'), d((0, e.g)(this)), h && h.call(this)));
                        }),
        ...
        60375: function (t, r, o) {
            ...
            function n(t, r) {
                var o;
                let e = null !== (o = r.parent) && void 0 !== o ? o : t.currentTarget,
                    n = e.getElementsByClassName(i)[0];
                (n && n.remove(), e.classList.add('ripple-parent'), a(e), Array.from(e.children).forEach(a));
                let s = document.createElement('span');
                (s.classList.add(i), (s.style.backgroundColor = `var(--atomic-${r.color})`), s.setAttribute('part', i));
                let c = Math.max(e.clientWidth, e.clientHeight),
                    d = c / 2,
                    p = 129.21 * Math.cbrt(d),
                    {top: m, left: g} = e.getBoundingClientRect();
