...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [47614],
    {
        31411: function (t, r, e) {
            e.d(r, {
                A: function () {
                    return o;
                },
            });
            let o = `<svg width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
        ...
        55704: function (t, r, e) {
            ...
            let o = `<svg viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.09619 10.5962L5.69239 6L1.09619 1.40381" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
        },
        47614: function (t, r, e) {
            (e.r(r),
                e.d(r, {
                    atomic_insight_smart_snippet_suggestions: function () {
                        return c;
                    },
                }));
            var o = e(5991),
                ...
                n = e(66038),
                l = e(32923);
            (e(87856), e(2108), e(9224));
            var s = function (t, r, e, o) {
                var i,
                    a = arguments.length,
            ...
            let c = class {
                constructor(t) {
                    ((0, o.r)(this, t),
                        (this.headingLevel = 0),
                        (this.id = (0, n.r)('atomic-smart-snippet-suggestions-')));
                }
                initialize() {
                    ((this.smartSnippetQuestionsList = (0, i.c)(this.bindings.engine)),
                        (this.smartSnippetSuggestionListCommon = new l.S({
                            id: this.id,
                            getHost: () => this.host,
                        ...
                        this.smartSnippetSuggestionListCommon.hideDuringRender(!0),
                        this.bindings.store.waitUntilAppLoaded(() => {
                            this.smartSnippetSuggestionListCommon.hideDuringRender(!1);
                        }));
                }
                renderRelatedQuestion(t, r) {
                    return this.smartSnippetSuggestionListCommon.renderRelatedQuestion(t, r);
                }
                render() {
                    ...
                    ((r.componentWillLoad = function () {
                        ...
                        let e = (0, i.b)(l, (r) => {
                            ...
                            (this.bindings.i18n.on('languageChanged', e),
                                (v = () => this.bindings.i18n.off('languageChanged', e)));
                            try {
                        ...
                        (r.render = function () {
                            return this.error
                                ...
                                : this.bindings
                                  ? ((0, o.g)(this).setAttribute(p, 'true'), g && g.call(this))
                                  : (0, o.h)(n, null);
                        }),
                        (r.disconnectedCallback = function () {
                            let t = (0, o.g)(this);
                            (t.setAttribute(p, 'false'), t.setAttribute(m, 'false'), v(), b && b.call(this));
                        }),
                        (r.componentDidRender = function () {
                            ...
                            'false' !== t.getAttribute(p) &&
                                ...
                                'false' === t.getAttribute(m) &&
                                    (t.setAttribute(m, 'true'), d((0, o.g)(this)), h && h.call(this)));
                        }),
        ...
        60375: function (t, r, e) {
            ...
            function n(t, r) {
                ...
                let c = Math.max(o.clientWidth, o.clientHeight),
                    d = c / 2,
                    p = 129.21 * Math.cbrt(d),
                    {top: m, left: u} = o.getBoundingClientRect();
                ((s.style.width = s.style.height = `${c}px`),
                    (s.style.left = `${t.clientX - (u + d)}px`),
        ...
        32923: function (t, r, e) {
            ...
            class c {
                ...
                get style() {
                    var t;
                    let r =
                        null === (t = this.props.getHost().querySelector('template')) || void 0 === t
                            ? void 0
                            : t.content.querySelector('style');
                    return r ? r.innerHTML : this.props.getSnippetStyle();
                }
                getRelatedQuestionId(t) {
                    return `${this.props.id}-${t}`;
                }
                getQuestionPart(t, r) {
                    return t + (r.expanded ? '-expanded' : '-collapsed');
                }
                toggleQuestion(t) {
                    t.expanded
                        ? this.props.getQuestionsList().collapse(t.questionAnswerId)
                        : this.props.getQuestionsList().expand(t.questionAnswerId);
                }
                renderQuestion(t, r) {
                    ...
                    return (0, o.h)(
                        ...
                        {
                            style: 'text-neutral',
                            part: this.getQuestionPart('question-button', t),
                            onClick: () => this.toggleQuestion(t),
                            class: 'flex items-center px-4',
                            ariaExpanded: `${t.expanded}`,
                            ariaControls: this.getRelatedQuestionId(r),
                        },
                        (0, o.h)('atomic-icon', {
                            icon: t.expanded ? i.A : a.A,
                            part: this.getQuestionPart('question-icon', t),
                        ...
                        (0, o.h)(
                            l.H,
                            {
                                ...
                                part: this.getQuestionPart('question-text', t),
                            },
                            t.question,
                        ),
                    );
                ...
                renderContent(t) {
                    return (0, o.h)('atomic-smart-snippet-answer', {
                        exportparts: 'answer',
                        htmlContent: t.answer,
                        innerStyle: this.style,
                        onSelectInlineLink: (r) =>
                            this.props.getQuestionsList().selectInlineLink(t.questionAnswerId, r.detail),
                        onBeginDelayedSelectInlineLink: (r) =>
                            this.props.getQuestionsList().beginDelayedSelectInlineLink(t.questionAnswerId, r.detail),
                        onCancelPendingSelectInlineLink: (r) =>
                            this.props.getQuestionsList().cancelPendingSelectInlineLink(t.questionAnswerId, r.detail),
                    });
                }
                renderSource(t) {
                    var r, e;
                    ...
                    return i
                        ? (0, o.h)(
                              ...
                              (0, o.h)('atomic-smart-snippet-source', {
                                  source: i,
                                  anchorAttributes:
                                      null === (e = (r = this.props).getSourceAnchorAttributes) || void 0 === e
                                          ? void 0
                                          : e.call(r),
                                  onSelectSource: () => this.props.getQuestionsList().selectSource(t.questionAnswerId),
                                  onBeginDelayedSelectSource: () =>
                                      this.props.getQuestionsList().beginDelayedSelectSource(t.questionAnswerId),
                                  onCancelPendingSelectSource: () =>
                                      this.props.getQuestionsList().cancelPendingSelectSource(t.questionAnswerId),
                              }),
                          )
                        : [];
                }
                hideDuringRender(t) {
                    let r = this.props.getHost();
                    ((r.style.visibility = t ? 'hidden' : ''), (r.style.position = t ? 'absolute' : ''));
                }
                renderRelatedQuestion(t, r) {
                    return (0, o.h)(
                        'li',
                        {
                            key: t.questionAnswerId,
                            part: this.getQuestionPart('question-answer', t),
                            class: 'flex flex-col',
                        },
                        (0, o.h)(
                            'article',
                            {class: 'contents'},
                            this.renderQuestion(t, r),
                            t.expanded &&
                                (0, o.h)(
                                    'div',
                                    {
                                        ...
                                        id: this.getRelatedQuestionId(r),
                                    },
                ...
                render() {
                    return this.props.getState().questions.length
                        ? (0, o.h)(
                              'aside',
                              {
                                  part: 'container',
                              ...
                              (0, o.h)(
                                  'ul',
                                  {part: 'questions', class: 'divide-neutral divide-y'},
                                  this.props.getState().questions.map((t, r) => this.renderRelatedQuestion(t, r)),
                              ),
                          )
                        : (0, o.h)(s.H, null);
                }
