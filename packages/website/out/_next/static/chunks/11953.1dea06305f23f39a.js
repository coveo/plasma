...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  />
                ...
                a = (r) => {
                    var t;
                    let o = ((r.numberOfActiveIcons / r.numberOfTotalIcons) * 100).toString() + '%',
                        i = `${null !== (t = r.iconSize) && void 0 !== t ? t : 0.75}rem`,
                        a = (t) =>
                            (0, e.h)('atomic-icon', {
                                icon: r.icon,
                                class: `shrink-0 ${t ? 'icon-active' : 'icon-inactive'}`,
                    ...
                    return (0, e.h)(
                        'div',
                        {
                            ...
                            part: 'value-rating',
                            role: 'img',
                            'aria-label': r.i18n.t('stars', {count: r.numberOfActiveIcons, max: r.numberOfTotalIcons}),
                        },
                        (0, e.h)(
                            'div',
                            ...
                            (() => {
                                let t = [];
                                for (let o = 0; o < r.numberOfTotalIcons; o++) t.push(a(!1));
                                return t;
                            })(),
                        ),
                        (0, e.h)(
                            'div',
                            {class: 'absolute left-0 top-0 z-1 flex gap-0.5 overflow-hidden', style: {width: o}},
                            (() => {
                                let t = [];
                                for (let o = 0; o < r.numberOfTotalIcons; o++) t.push(a(!0));
                                return t;
                            })(),
                        ),
                    );
        ...
        11953: function (r, t, o) {
            (o.r(t),
                o.d(t, {
                    atomic_result_rating: function () {
                        return c;
                    },
                }));
            var e = o(5991),
            ...
            let c = class {
                constructor(r) {
                    ((0, e.r)(this, r), (this.maxValueInIndex = 5), (this.icon = a.S), (this.numberOfStars = null));
                }
                updateNumberOfStars() {
                    let r = i.a.getResultProperty(this.result, this.field);
                    if (null === r) {
                    ...
                    let t = parseFloat(`${r}`);
                    if (Number.isNaN(t)) {
                        ((this.error = Error(`Could not parse "${r}" from field "${this.field}" as a number.`)),
                            (this.numberOfStars = null));
                        return;
                    }
                    this.numberOfStars = t;
                }
                componentWillRender() {
                    this.updateNumberOfStars();
                }
                render() {
                    if (null === this.numberOfStars) {
                        this.host.remove();
                        return;
                    }
                    return (0, e.h)(a.R, {
            ...
            (s([(0, n.I)()], c.prototype, 'bindings', void 0),
                s([(0, l.R)()], c.prototype, 'result', void 0),
                (c.style =
                    ...
                    ((t.componentWillLoad = function () {
                        ...
                        (t.render = function () {
                            return this.error
                                ...
                                : this.bindings
                                  ? ((0, e.g)(this).setAttribute(m, 'true'), w && w.call(this))
                                  : (0, e.h)(n, null);
                        }),
                        ...
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), d((0, e.g)(this)), h && h.call(this)));
                        }),
        ...
        18043: function (r, t, o) {
            ...
            class a extends Error {
                constructor(r) {
                    super(`The "${r}" element must be the child of an "atomic-result" element.`);
                }
            }
            function n(r = {folded: !1}) {
                return (t, o) => {
                    let {connectedCallback: n, componentWillRender: l, render: c} = t;
                        ...
                        let t = (0, e.g)(this),
                            l = (0, i.b)(s, (t) => {
                                r.folded
                                    ? d(t)
                                        ? (this[o] = t)
                                        : (this[o] = {children: [], result: t})
                                    : (this[o] = d(t) ? t.result : t);
                            }),
                            c = t.dispatchEvent(l);
                        if (c) {
            ...
            function l() {
                return (r, t) => {
                    let {connectedCallback: o} = r;
                    r.connectedCallback = function () {
                        let r = (0, e.g)(this),
                            a = (0, i.b)(c, (r) => {
                                this[t] = r;
                            });
                        return (r.dispatchEvent(a), o && o.call(this));
                    };
                };
            }
            ...
            function m() {
                return (r, t) => {
                    let {componentWillRender: o} = r;
                    r.componentWillRender = function () {
                        let r = (0, e.g)(this),
                            a = (0, i.b)('atomic/resolveChildTemplates', (r) => {
                                this.resultTemplateProvider || (this[t] = r);
                            }),
                            n = r.dispatchEvent(a);
                        if (n) {
                            this[t] = null;
            ...
            function p() {
                return (r, t) => {
                    ...
                    r.componentWillRender = function () {
                        let r = (0, e.g)(this),
                            a = (0, i.b)('atomic/resolveResultDisplayConfig', (r) => {
                                this[t] = r;
                            }),
                            n = r.dispatchEvent(a);
                        if (!n) return o && o.call(this);
                    };
                };
            }
        },
