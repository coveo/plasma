!(function () {
    ...
    var ie =
        ...
        fe = {forEach: ce(0), map: ce(1), filter: ce(2), some: ce(3), every: ce(4), find: ce(5), findIndex: ce(6)},
    ...
    (Lt(
        {target: 'Array', proto: !0},
        {
            flatMap: function (t) {
                ...
                return (
                    ee(t),
                    ((e = ue(r, 0)).length = Ae(e, r, r, n, 0, 1, t, arguments.length > 1 ? arguments[1] : void 0)),
                    e
                );
            },
        },
    ...
    var Oe,
        ...
        Me = qt('iterator'),
        _e = !1;
    ([].keys && ('next' in (je = [].keys()) ? (Re = Ue(Ue(je))) !== Object.prototype && (Oe = Re) : (_e = !0)),
        null == Oe && (Oe = {}),
        w(Oe, Me) ||
            T(Oe, Me, function () {
                return this;
        ...
        Ze = function (t, e, r, n, o, i, a) {
            ...
            if (
                (g &&
                    ...
                    $e !== Object.prototype &&
                        u.next &&
                        (Ue(u) !== $e && (Ge ? Ge(u, $e) : 'function' != typeof u[He] && T(u, He, Qe)), Be(u, l, !0))),
                o == Ye &&
                    d &&
                    d.name !== Ye &&
                    ((h = !0),
    ...
    var Nr = !o(function () {
        ...
        qr = function (t, e, r) {
            ...
            return ((l[t] = f), Lt({global: !0, forced: f != s}, l), Be(f, t), a || r.setStrong(f, t, i), f);
        },
        zr = function (t, e, r) {
    ...
    if (
        ...
        for (
            var di = function (t, e) {
                    ...
                    (hi ? o && !i && (t = t.source) : t instanceof di && (i && (e = Zo.call(t)), (t = t.source)),
    ...
    (Lt({target: 'RegExp', proto: !0, forced: /./.exec !== ji}, {exec: ji}),
        i && ('g' != /./g.flags || ni.UNSUPPORTED_Y) && I.f(RegExp.prototype, 'flags', {configurable: !0, get: Zo}));
    var Pi = et.get,
        Ii = RegExp.prototype;
    i &&
        ni.UNSUPPORTED_Y &&
        ...
        return [
            ...
            function (t, n) {
                ...
                for (var g, y = '', m = 0, b = 0; b < d.length; b++) {
                    v = d[b];
                    for (var w = String(v[0]), S = Ki(Gi(st(v.index), f.length), 0), E = [], x = 1; x < v.length; x++)
    ...
    aa
        ...
        : na && (!(ea = na.match(/Edge\/(\d+)/)) || ea[1] >= 74) && (ea = na.match(/Chrome\/(\d+)/)) && (ra = ea[1]);
    var ua = ra && +ra,
        sa = qt('species'),
    ...
    if (
        ...
        Lt({target: 'Object', stat: !0, forced: !Nt}, {getOwnPropertyNames: Ya, getOwnPropertySymbols: Ja}),
        Lt(
            {
                target: 'Object',
                stat: !0,
    ...
    var ku = function (t) {
        ...
        Mu = Uu
            ...
            : ''.trimStart;
    (Lt({target: 'String', proto: !0, forced: Uu}, {trimStart: Mu, trimLeft: Mu}), oe('String', 'trimLeft'));
    var _u = bn.end,
        Nu = ku('trimEnd'),
        Cu = Nu
            ? function () {
            ...
            : ''.trimEnd;
    (Lt({target: 'String', proto: !0, forced: Nu}, {trimEnd: Cu, trimRight: Cu}), oe('String', 'trimRight'));
    var Fu = qt('iterator'),
        Bu = !o(function () {
        ...
        vs = function (t, e) {
            if (e)
                for (var r, n, o = e.split('&'), i = 0; i < o.length; )
                    (r = o[i++]).length && ((n = r.split('=')), t.push({key: fs(n.shift()), value: fs(n.join('='))}));
        },
        gs = function (t) {
        ...
        bs = function () {
            ...
            var t,
                ...
                f = [];
            if ((ns(this, {type: es, entries: f, updateURL: function () {}, updateSearchParams: gs}), void 0 !== c))
                if (y(c))
    ...
    (zr(
        ws,
        {
            ...
            has: function (t) {
                ys(arguments.length, 1);
                for (var e = os(this).entries, r = t + '', n = 0; n < e.length; ) if (e[n++].key === r) return !0;
                return !1;
            },
            set: function (t, e) {
                ys(arguments.length, 1);
                for (var r, n = os(this), o = n.entries, i = !1, a = t + '', u = e + '', s = 0; s < o.length; s++)
            ...
            forEach: function (t) {
                for (
                    var e, r = os(this).entries, n = re(t, arguments.length > 1 ? arguments[1] : void 0, 3), o = 0;
                    o < r.length;
    ...
    var Ss,
        ...
        $s = function (t) {
            ...
            for (r = [], n = 0; n < e; n++) {
                ...
                if (
                    ((i = 10),
                    o.length > 1 && '0' == o.charAt(0) && ((i = Cs.test(o) ? 16 : 8), (o = o.slice(8 == i ? 1 : 2))),
                    '' === o)
                )
                    a = 0;
                else {
    ...
    (Zc && tf) ||
        ...
        'process' == h(ef)
            ...
            : nf && nf.now
              ...
              : rf && !Jc
                ? ((Xc = (Hc = new rf()).port2), (Hc.port1.onmessage = ff), (Vc = re(Xc.postMessage, Xc, 1)))
                : !n.addEventListener ||
                        ...
                        try {
                            l
                                ? (i || (2 === e.rejection && ul(t, e), (e.rejection = 1)),
                                  ...
                                  u === f.promise ? p(Gf('Promise-chain cycle')) : (s = rl(u)) ? s.call(u, h, p) : h(u))
                                : p(o);
                        } catch (t) {
                            (d && !c && d.exit(), p(t));
                        }
    ...
    ((dl.prototype = Jt(Error.prototype, {constructor: f(5, dl), message: f(5, ''), name: f(5, 'AggregateError')})),
        i &&
    ...
    function Ul(t, e) {
        ...
        if (
            ...
            (this.method = ((n = (r = e.method || this.method || 'GET').toUpperCase()), Ll.indexOf(n) > -1 ? n : r)),
    ...
    ((Fl.polyfill = !0),
        self.fetch || ((self.fetch = Fl), (self.Headers = Rl), (self.Request = Ul), (self.Response = _l)));
