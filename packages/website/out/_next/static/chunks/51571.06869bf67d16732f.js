(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        51571, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
        95153, 97612, 73877, 51843, 96429, 78364, 27682, 36569, 89613, 73492, 17036,
    ],
    {
        81491: function (r, t, e) {
            'use strict';
            (e.r(t),
                e.d(t, {
                    atomic_insight_result_children: function () {
                        return h;
                    },
                }));
            var i = e(5991),
                ...
                c = e(1212),
                m = e(18043);
            (e(87856), e(70835), e(2108), e(64977));
            var p = function (r, t, e, i) {
                var o,
                    a = arguments.length,
                    n = a < 3 ? t : null === i ? (i = Object.getOwnPropertyDescriptor(t, e)) : i;
                if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
                    n = Reflect.decorate(r, t, e, i);
                else
                    for (var l = r.length - 1; l >= 0; l--)
                        (o = r[l]) && (n = (a < 3 ? o(n) : a > 3 ? o(t, e, n) : o(t, e)) || n);
                return (a > 3 && n && Object.defineProperty(t, e, n), n);
            };
            let g = 'atomic-insight-result-children-template',
                h = class {
                    constructor(r) {
                        ((0, i.r)(this, r),
                            (this.resultTemplateRegistered = !1),
                            (this.templateHasError = !1),
                            (this.showInitialChildren = !1),
                            (this.inheritTemplates = !1),
                            (this.noResultText = 'no-documents-related'));
                    }
                    resolveChildTemplates(r) {
                        (r.preventDefault(), r.detail(this.resultTemplateProvider));
                    }
                    initialize() {
                        if (
                            ((this.resultChildrenCommon = new s.R({
                                getHost: () => this.host,
                                ...
                                setInitialChildren: (r) => (this.initialChildren = r),
                                toggleShowInitialChildren: () => (this.showInitialChildren = !this.showInitialChildren),
                            })),
                            this.inheritTemplates)
                        )
                            return;
                        let r = Array.from(this.host.querySelectorAll(g)).filter((r) => !(0, n.j)(r, g));
                        if (!r.length) {
                            this.error = Error(
                                `The "atomic-insight-result-children" component requires at least one "${g}" component.`,
                            );
                            return;
                        }
                        this.resultTemplateProvider = new c.R({
                            includeDefaultTemplate: !1,
                            templateElements: r,
                            getResultTemplateRegistered: () => this.resultTemplateRegistered,
                            getTemplateHasError: () => this.templateHasError,
                            setResultTemplateRegistered: (r) => {
                                this.resultTemplateRegistered = r;
                            },
                            setTemplateHasError: (r) => {
                                this.templateHasError = r;
                            },
                    ...
                    renderChild(r, t) {
                        var e;
                        let a =
                            null === (e = this.resultTemplateProvider) || void 0 === e
                                ? void 0
                                : e.getTemplateContent(r.result);
                        if (!a) return;
                        let n = r.result.uniqueId + r.children.map((r) => r.result.uniqueId);
                        return (0, i.h)('atomic-insight-result', {
                            key: n,
                            content: a,
                            result: r,
                            interactiveResult: (0, o.Q)(this.bindings.engine, {options: {result: (0, l.e)(r)}}),
                            store: this.bindings.store,
                            density: this.displayConfig.density,
                            imageSize: this.imageSize || this.displayConfig.imageSize,
                            classes: `child-result ${t ? 'last-child' : ''}`.trim(),
                        });
                    }
                    componentWillRender() {
        ...
        70835: function (r, t, e) {
            ...
            var i = e(5991);
            let o = (r) =>
                    Array.from({length: r.numberOfPlaceholders}, (t, e) =>
                        (0, i.h)('atomic-result-placeholder', {
                            key: `placeholder-${e}`,
                            density: r.density,
                            display: r.display || 'list',
                            imageSize: r.imageSize,
                        }),
                    ),
                a = (r) =>
                    (0, i.h)('atomic-result-table-placeholder', {
                        density: r.density,
                        imageSize: r.imageSize,
                        rows: r.numberOfPlaceholders,
                    });
        },
        32767: function (r, t, e) {
            'use strict';
            e.d(t, {
                R: function () {
                    return n;
            ...
            class n {
                ...
                get collection() {
                    return this.props
                        .getFoldedResultListState()
                        .results.find((r) => r.result.uniqueId === this.props.getResult().result.uniqueId);
                }
                renderPlaceholder() {
                    return (0, i.h)(o.R, {
                        numberOfPlaceholders: this.numberOfChildren || 2,
                        density: this.props.getDisplayConfig().density,
                        imageSize: this.props.getImageSize() || this.props.getDisplayConfig().imageSize,
                    });
                }
                renderNoResult() {
                    return (0, i.h)(
                        'p',
                        {part: 'no-result-root', class: 'no-result-root my-3'},
                        this.props.getBindings().i18n.t(this.props.getNoResultText()),
                    );
                }
                renderCollapseButton() {
                    let r = this.collection;
                    if (r.children.length && !r.moreResultsAvailable)
                        return (0, i.h)(
                            a.B,
                            {
                            ...
                            this.props
                                .getBindings()
                                .i18n.t(this.props.getShowInitialChildren() ? 'load-all-results' : 'collapse-results'),
                        );
                }
                renderChildrenWrapper(r) {
                    return (0, i.h)(
                        'div',
                        {part: 'children-root'},
                        this.hasChildren && (0, i.h)('slot', {name: 'before-children'}),
                        r,
                        this.hasChildren && (0, i.h)('slot', {name: 'after-children'}),
                    );
                }
                renderChildren(r) {
                    return this.renderChildrenWrapper(r.map((t, e) => this.props.renderChild(t, e === r.length - 1)));
                }
                renderCollection() {
                    var r;
                    let t = this.collection;
                    if (t.isLoadingMoreResults) return this.renderChildrenWrapper(this.renderPlaceholder());
                    if (!t.moreResultsAvailable && !this.hasChildren)
                        return (null === (r = this.props.getNoResultText()) || void 0 === r ? void 0 : r.trim().length)
                            ? this.renderNoResult()
                            : null;
                    if (!this.hasChildren) return;
                    let e = this.props.getShowInitialChildren() ? this.props.getInitialChildren() : t.children;
                    return (0, i.h)(i.H, null, this.renderCollapseButton(), this.renderChildren(e));
                }
                renderFoldedResult() {
                    if (this.hasChildren) return this.renderChildren(this.foldedResult.children);
                }
                componentWillRender() {
                    let r = this.collection;
                    !this.props.getInitialChildren() && r && this.props.setInitialChildren(r.children);
                }
                render() {
                    return this.props.getInheritTemplates() || this.props.getResultTemplateRegistered()
                        ? !this.props.getInheritTemplates() && this.props.getTemplateHasError()
                            ? (0, i.h)('slot', null)
                            : this.collection
        ...
        22029: function (r) {
            function t(r) {
                var t = Error("Cannot find module '" + r + "'");
