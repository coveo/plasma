...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [10398],
    {
        31411: function (t, r, e) {
            ...
            let i = `<svg width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.18998 0.52682L5.43262 4.76946L9.67526 0.526821" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
        },
        10398: function (t, r, e) {
            (e.r(r),
                e.d(r, {
                    atomic_smart_snippet_expandable_answer: function () {
                        return l;
                    },
                }));
            var i = e(5991),
            ...
            let l = class {
                constructor(t) {
                    ((0, i.r)(this, t),
                        (this.expand = (0, i.c)(this, 'expand', 7)),
                        (this.collapse = (0, i.c)(this, 'collapse', 7)),
                        (this.selectInlineLink = (0, i.c)(this, 'selectInlineLink', 3)),
                        (this.beginDelayedSelectInlineLink = (0, i.c)(this, 'beginDelayedSelectInlineLink', 3)),
                        (this.cancelPendingSelectInlineLink = (0, i.c)(this, 'cancelPendingSelectInlineLink', 3)),
                ...
                establishInitialHeight() {
                    let t = document.createElement('atomic-smart-snippet-answer');
                    return (
                        (t.htmlContent = this.htmlContent),
                        (t.innerStyle = this.snippetStyle),
                        (t.style.visibility = 'hidden'),
                        (t.style.position = 'absolute'),
                        new Promise((r) => {
                            ((0, a.l)(t, 'answerSizeUpdated', (e) => {
                                (t.remove(), r(e.detail.height));
                            }),
                ...
                renderAnswer() {
                    return (0, i.h)(
                        ...
                        (0, i.h)('atomic-smart-snippet-answer', {
                            exportparts: 'answer',
                            htmlContent: this.htmlContent,
                            innerStyle: this.snippetStyle,
                            onAnswerSizeUpdated: (t) => (this.fullHeight = t.detail.height),
                            onSelectInlineLink: (t) => this.selectInlineLink.emit(t.detail),
                            onBeginDelayedSelectInlineLink: (t) => this.beginDelayedSelectInlineLink.emit(t.detail),
                            onCancelPendingSelectInlineLink: (t) => this.cancelPendingSelectInlineLink.emit(t.detail),
                        }),
                    );
                }
                renderButton() {
                    if (this.showButton)
                        return (0, i.h)(
                            'button',
                            {
                                onClick: () => (this.isExpanded ? this.collapse.emit() : this.expand.emit()),
                            ...
                            (0, i.h)('atomic-icon', {icon: o.A, class: 'w-3 ml-2 align-baseline'}),
                        );
                }
                render() {
                    return (0, i.h)(
                ...
                static get watchers() {
                    return {fullHeight: ['fullHeightUpdated']};
                }
            };
            (!(function (t, r, e, i) {
                var o,
                ...
                return (r, e) => {
                    ...
                    ((r.componentWillLoad = function () {
                        ...
                        (r.disconnectedCallback = function () {
                            let t = (0, i.g)(this);
                            (t.setAttribute(m, 'false'), t.setAttribute(p, 'false'), v(), b && b.call(this));
                        }),
                        (r.componentDidRender = function () {
                            ...
                            'false' !== t.getAttribute(m) &&
                                ...
                                'false' === t.getAttribute(p) &&
                                    (t.setAttribute(p, 'true'), d((0, i.g)(this)), u && u.call(this)));
                        }),
