...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [51170],
    {
        ...
        51170: function (r, t, o) {
            (o.r(t),
                o.d(t, {
                    atomic_segmented_facet_scrollable: function () {
                        return d;
                    },
                }));
            var e = o(5991),
            ...
            let d = class {
                constructor(r) {
                    ((0, e.r)(this, r), (this.hideLeftArrow = !0), (this.hideRightArrow = !0));
                }
                initialize() {
                ...
                componentDidLoad() {
                    ((this.observer = new ResizeObserver(() => {
                        ...
                        Array.from(this.host.children).forEach((r) => this.observer.observe(r)),
                ...
                handleScroll() {
                    if (!this.horizontalScrollRef) return;
                    let r = this.horizontalScrollRef,
                        t = r.clientWidth < r.scrollWidth,
                        o = 0 >= Math.floor(r.scrollLeft),
                        e = Math.ceil(r.scrollLeft) >= r.scrollWidth - r.clientWidth;
                    ((this.hideLeftArrow = !t || o), (this.hideRightArrow = !t || e));
                }
                slideHorizontally(r) {
                    let t = this.horizontalScrollRef,
                        o = 2 * this.arrowRef.clientWidth,
                        e = (t.clientWidth - o) * 0.7,
                        i = 0 >= Math.floor(t.scrollLeft - e),
                        a = Math.ceil(t.scrollLeft + e) >= t.scrollWidth - t.clientWidth;
                    if (((this.hideLeftArrow = !1), (this.hideRightArrow = !1), 'left' === r)) {
                        ((t.scrollLeft -= e), (this.hideLeftArrow = i));
                        return;
                    }
                    ((t.scrollLeft += e), (this.hideRightArrow = a));
                }
                renderArrow(r) {
                    let t = ('left' === r && this.hideLeftArrow) || ('right' === r && this.hideRightArrow),
                        o = this.bindings.store.isAppLoaded() ? 'transition-visi-opacity ease-in-out duration-300' : '';
                    return (0, e.h)(
                        'div',
                        {part: `${r}-arrow-wrapper`, class: `${t ? 'invisible opacity-0' : ''} ${o}`},
                        (0, e.h)(
                            s.B,
                            {
                                part: `${r}-arrow-button`,
                                style: 'square-neutral',
                                class: `flex shrink-0 basis-8 justify-center items-center rounded absolute z-1 h-10 w-10 top-0 bottom-0 ${'left' === r ? 'left-0' : 'right-0'}`,
                                ariaHidden: 'true',
                                tabIndex: '-1',
                                onClick: () => this.slideHorizontally(r),
                        ...
                        (0, e.h)('div', {
                            part: `${r}-fade`,
                            class: `w-20 h-10 absolute top-0 z-0 pointer-events-none from-background-60 ${'left' === r ? 'left-0 bg-gradient-to-r' : 'right-0 bg-gradient-to-l'}`,
                        }),
                    );
                }
                render() {
                    return this.searchStatus.state.hasError
                        ? (0, e.h)(l.H, null)
                        : (0, e.h)(
                              'div',
                              {part: 'scrollable-container', class: 'flex relative'},
                              ...
                              (0, e.h)(
                                  'div',
                                  {
                                      ...
                                      ref: (r) => (this.horizontalScrollRef = r),
                                  },
                                  (0, e.h)('slot', null),
                              ),
        ...
        2108: function (r, t, o) {
            ...
            let n = (r, t) => {
                ...
                return (0, e.h)(
                    'button',
                    {...l, onMouseDown: (r) => (0, i.c)(r, {color: o})},
                    r.text ? (0, e.h)('span', {class: 'truncate'}, r.text) : null,
                    t,
                );
            };
        },
                        ...
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), d((0, e.g)(this)), u && u.call(this)));
                        }),
        ...
        60375: function (r, t, o) {
            ...
            function n(r, t) {
                var o;
                let e = null !== (o = t.parent) && void 0 !== o ? o : r.currentTarget,
                ...
                let c = Math.max(e.clientWidth, e.clientHeight),
                    ...
                    {top: p, left: g} = e.getBoundingClientRect();
