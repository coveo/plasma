(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        1708, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
        95153, 97612, 73877, 51843, 96429, 78364, 27682, 36569, 89613, 73492, 17036,
    ],
    {
        80421: function (r, t, o) {
            'use strict';
            o.d(t, {
                A: function () {
                    return a;
            ...
            function a(r, t = !1) {
                function o() {
                    let r = (0, i.b)('atomic/accessibility/findAriaLive', {});
                    document.dispatchEvent(r);
                    let {element: t} = r.detail;
                    return t;
                }
                return (i, e) => {
                    ...
                    (Object.defineProperty(i, e, {
                        set: (i) => {
                            var e;
                            null === (e = o()) || void 0 === e || e.updateMessage(r, i, t);
                        },
                    }),
                        (i.componentWillRender = function () {
                            var i;
                            (a && a.call(this), null === (i = o()) || void 0 === i || i.registerRegion(r, t));
                        }));
                };
            }
            function n() {
                return (r, t) => {
                    let {componentWillLoad: o} = r;
                    r.componentWillLoad = function () {
                        ...
                        this.componentDidRender = function () {
                            if (
                                ...
                                this.bindings &&
                                    n &&
                                    this.bindings.store.getUniqueIDFromEngine(this.bindings.engine) !== r &&
                                    ((n = !1), i))
                            ) {
                                let r = i;
                                (0, e.d)().then(() => {
                        ...
                        let c = {
                            ...
                            focus: async () => {
                                (await (0, e.d)(), null == i || i.focus(), null == s || s());
                            },
                            focusAfterSearch: () => (
                                (r = this.bindings.store.getUniqueIDFromEngine(this.bindings.engine)),
                                (n = !0),
                                new Promise((r) => (s = r))
                            ),
                            focusOnNextTarget: () => ((l = !0), new Promise((r) => (s = r))),
                            disableForCurrentSearch: () =>
                                this.bindings.store.getUniqueIDFromEngine(this.bindings.engine) !== r && (n = !1),
                        };
                        this[t] = c;
                    };
                };
            ...
            function l(r) {
                ...
                return null !==
                    (t = (function* r(t) {
                        (function (r) {
                            if ('-1' === r.getAttribute('tabindex')) return !1;
                            if (r.hasAttribute('tabindex') || 'true' === r.getAttribute('contentEditable')) return !0;
                            switch (r.tagName) {
                                case 'A':
                                case 'AREA':
                        ...
                        for (let i of (t instanceof HTMLSlotElement
                            ? (o = t.assignedElements())
                            : t.shadowRoot && o.push(...Array.from(t.shadowRoot.children)),
                        o))
                            yield* r(i);
                    })(r).next().value) && void 0 !== t
                    ? t
                    : null;
            }
        },
        41700: function (r, t, o) {
            'use strict';
            (o.r(t),
                o.d(t, {
                    atomic_notifications: function () {
                        return d;
                    },
                }));
            var i = o(5991),
                ...
                l = o(9224);
            (o(66038), o(87856));
            let s = `<svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
            ...
            let d = class {
                constructor(r) {
                    ((0, i.r)(this, r), (this.headingLevel = 0));
                }
                initialize() {
                    this.notifyTrigger = (0, e.W)(this.bindings.engine);
                }
                generateAriaMessage() {
                    return 1 === this.notifications.length
                        ? this.notifications[0]
                        : this.notifications
                              .map((r, t) => this.bindings.i18n.t('notification-n', {n: t + 1, text: r}))
                              .join('\n');
                }
                renderNotification(r) {
                    ...
                    return (0, i.h)(
                        ...
                        (0, i.h)('atomic-icon', {
                            icon: null !== (t = this.icon) && void 0 !== t ? t : s,
                            part: 'icon',
                            class: 'w-7 h-7 mr-6 text-neutral-dark',
                        }),
                        (0, i.h)('span', {part: 'text', class: 'leading-5 text-base text-on-background'}, r),
                    );
                }
                renderNotifications() {
                    return (0, i.h)(
                        'div',
                        {part: 'notifications', class: 'flex flex-col gap-4'},
                        this.notifications.map((r) => this.renderNotification(r)),
                    );
                }
                render() {
                    var r;
                        ...
                        ? ((this.ariaMessage = this.generateAriaMessage()),
                          (0, i.h)(
                              ...
                              (0, i.h)(
                                  l.H,
                                  {
                                      level: null !== (r = this.headingLevel) && void 0 !== r ? r : 0,
                ...
                get notifications() {
                    var r;
                    return (null === (r = this.notifyTriggerState) || void 0 === r ? void 0 : r.notifications) || [];
                }
            };
            (c([(0, n.I)()], d.prototype, 'bindings', void 0),
                c([(0, n.B)('notifyTrigger')], d.prototype, 'notifyTriggerState', void 0),
                c([(0, a.A)('notifications')], d.prototype, 'ariaMessage', void 0),
                (d.style =
                        ...
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), d((0, i.g)(this)), h && h.call(this)));
                        }),
