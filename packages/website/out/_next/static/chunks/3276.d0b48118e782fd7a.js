...
`;
        ...
        3276: function (t, r, e) {
            (e.r(r),
                e.d(r, {
                    atomic_smart_snippet_suggestions: function () {
                        return d;
                    },
                }));
            var o = e(5991),
            ...
            let d = class {
                ...
                initialize() {
                    ((this.smartSnippetQuestionsList = (0, i.z)(this.bindings.engine)),
                        (this.smartSnippetSuggestionListCommon = new s.S({
                            id: this.id,
                            getSourceAnchorAttributes: () => (0, l.a)(this.host, 'source-anchor-attributes'),
                            getHost: () => this.host,
            ...
            (c([(0, a.I)()], d.prototype, 'bindings', void 0),
                c([(0, a.B)('smartSnippetQuestionsList')], d.prototype, 'smartSnippetQuestionsListState', void 0),
                (d.style =
        ...
        39881: function (t, r, e) {
            function o(t) {
                let r = Array.from(t.children),
                    e = r.filter((t) => !t.hasAttribute('slot') || '' === t.getAttribute('slot'));
                if (e.length)
                    return (e.length > 1 && console.warn('Element should only have 1 default slot.', t), e[0]);
            }
            function i(t, r) {
                let e = (function (t, r) {
                    let e = Array.from(t.children),
                        o = e.filter((t) => t.getAttribute('slot') === r);
                    if (o.length)
                        return (o.length > 1 && console.warn(`Element should only have 1 slot named "${r}".`, t), o[0]);
                })(t, r);
                if (e) {
                    if ('A' !== e.nodeName) {
                        console.warn(`Slot named "${r}" should be an "a" tag`, e);
                        return;
                    }
                        ...
                        (r.componentDidRender = function () {
                            ...
                            'false' !== t.getAttribute(p) &&
                                ...
                                'false' === t.getAttribute(m) &&
                                    (t.setAttribute(m, 'true'), d((0, o.g)(this)), w && w.call(this)));
                        }),
