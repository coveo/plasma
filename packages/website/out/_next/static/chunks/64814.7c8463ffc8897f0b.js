(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [
        64814, 22029, 20337, 29889, 26155, 21730, 20946, 29343, 25908, 22035, 21187, 51367, 98309, 168, 77895, 51621,
    ...
    ],
    {
        4654: function (r, t, o) {
            ...
            let s = class {
                ...
                initialize() {
                    ((this.didYouMean = (0, e.y)(this.bindings.engine)),
                        (this.queryTrigger = (0, e._)(this.bindings.engine)));
                }
                withQuery(r, t) {
                    return (0, i.h)(n.L, {
                        bindings: this.bindings,
                        key: r,
                        params: {query: (0, i.h)('b', {part: 'highlight'}, t)},
                    });
                }
                renderQueryTriggerAutomaticallyCorrected() {
                    var r;
                    return (0, i.h)(
                        i.F,
                        null,
                        (0, i.h)(
                            'p',
                            {class: 'text-on-background leading-6 text-lg', part: 'showing-results-for'},
                            this.withQuery('showing-results-for', this.queryTriggerState.newQuery),
                        ),
                        (0, i.h)(
                            'p',
                            {class: 'text-on-background leading-5 text-base', part: 'search-instead-for'},
                            (0, i.h)(n.L, {
                                bindings: this.bindings,
                                ...
                                params: {
                                    query: (0, i.h)(
                                        'button',
                                        {class: 'link py-1', part: 'undo-btn', onClick: () => this.queryTrigger.undo()},
                                        null === (r = this.queryTriggerState) || void 0 === r
                                            ? void 0
                                            : r.originalQuery,
                                    ),
                                },
                ...
                renderDidYouMeanAutomaticallyCorrected() {
                    return (0, i.h)(
                        ...
                        (0, i.h)(
                            'p',
                            {class: 'text-on-background mb-1', part: 'no-results'},
                            this.withQuery('no-results-for-did-you-mean', this.didYouMeanState.originalQuery),
                        ),
                        (0, i.h)(
                            'p',
                            {class: 'text-on-background', part: 'auto-corrected'},
                            this.withQuery('query-auto-corrected-to', this.didYouMeanState.wasCorrectedTo),
                        ),
                    );
                }
                renderDidYouMeanCorrection() {
                    return (0, i.h)(
                        'p',
                        {class: 'text-on-background', part: 'did-you-mean'},
                        (0, i.h)(n.L, {
                            bindings: this.bindings,
                            key: 'did-you-mean',
                            params: {
                ...
                render() {
                    var r, t;
                    return (null === (r = this.didYouMeanState) || void 0 === r ? void 0 : r.hasQueryCorrection)
                        ? this.didYouMeanState.wasAutomaticallyCorrected
                            ? this.renderDidYouMeanAutomaticallyCorrected()
                            : this.renderDidYouMeanCorrection()
                        : (null === (t = this.queryTriggerState) || void 0 === t ? void 0 : t.wasQueryModified)
                          ? this.renderQueryTriggerAutomaticallyCorrected()
                          : (0, i.h)(a.H, null);
                }
            };
            (l([(0, a.I)()], s.prototype, 'bindings', void 0),
                l([(0, a.B)('didYouMean')], s.prototype, 'didYouMeanState', void 0),
                l([(0, a.B)('queryTrigger')], s.prototype, 'queryTriggerState', void 0),
                (s.style =
                        ...
                        (t.componentDidRender = function () {
                            ...
                            'false' !== r.getAttribute(m) &&
                                ...
                                'false' === r.getAttribute(p) &&
                                    (r.setAttribute(p, 'true'), c((0, i.g)(this)), h && h.call(this)));
                        }),
        ...
        45403: function (r, t, o) {
            ...
            var i = o(5991);
            let e = ({bindings: r, key: t, params: o, count: e}) => {
                let a = (r) => `${r}`,
                    n = (r) => o[r.slice(1)],
                    l = Object.fromEntries(Object.keys(o).map((r) => [r, a(r)])),
                    s = r.i18n.t(t, {interpolation: {escapeValue: !1}, count: e, ...l});
                return (0, i.h)(
                    i.F,
                    null,
                    s.split('\x1d').map((r) => (r.startsWith('\x1a') ? n(r) : r)),
                );
            };
        },
        22029: function (r) {
