    ...
    return (
        <>
            <div className="tab-navigation">
                <div id="tab1" className={`tab enabled ${active === 1 ? 'active' : ''}`} onClick={() => setActive(1)}>Tab 1</div>
                <div id="tab2" className={`tab enabled ${active === 2 ? 'active' : ''}`} onClick={() => setActive(2)}>Tab 2</div>
            </div>
