            ...
            <div className="split-layout">
                <div className="calendar column">
                    ...
                    <table className="calendar-grid">
                        ...
                        <tbody>
                        <tr>
                            <td><span className="other-month-date">29</span></td>
                            <td><span className="other-month-date">30</span></td>
                            <td><span className="other-month-date">31</span></td>
                            <td><span className="selected-date bg-blue lower-limit upper-limit">1<span></span></span></td>
                            <td><span>2</span></td>
                            <td><span>3</span></td>
                            <td><span>4</span></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><span>27</span></td>
                            <td><span>28</span></td>
                            <td><span className="other-month-date">1</span></td>
                            <td><span className="other-month-date">2</span></td>
                            <td><span className="other-month-date">3</span></td>
                            <td><span className="other-month-date">4</span></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div className="date-picker-box flex flex-column mt2">
            <div className="split-layout">
                <div className="calendar column">
                    ...
                    <table className="calendar-grid">
                        ...
                        <tr>
                            ...
                            <td><span className="other-month-date">30</span></td>
                            <td><span className="other-month-date">31</span></td>
                            <td><span className="selected-date bg-blue lower-limit">1</span></td>
                            <td><span className="todays-date selected-date bg-blue upper-limit">2</span></td>
                            <td><span>3</span></td>
                            <td><span>4</span></td>
                        </tr>
                        <tr>
                ...
                <div className="date-selection column p2">
                    ...
                    <button type="button" className="clear-selection-button mt2">Clear</button>
                </div>
            </div>
            <footer className="modal-footer mod-small">
                <button className="btn mod-primary mod-small">Apply</button>
        ...
        <div className="date-picker-dropdown mt2">
            <div className="dropdown-wrapper open">
                <span className="dropdown-toggle btn inline-flex flex-center">
                    <span className="dropdown-selected-value"><label>Select date</label></span>
                    ...
                    <div className="split-layout">
                        <div className="calendar column">
                            ...
                            <table className="calendar-grid">
                                ...
                                <tbody>
                                <tr>
                                    <td><span className="other-month-date">29
                                        </span></td>
                                    <td><span className="other-month-date">30
                                        </span></td>
                                    <td><span className="other-month-date">31
                                        </span></td>
                                    <td><span>1</span></td>
                                    <td><span>2</span></td>
                                    <td><span className="todays-date selected-date bg-blue lower-limit upper-limit">3
                                        <span></span></span></td>
                                    <td><span>4</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span>27</span></td>
                                    <td><span>28</span></td>
                                    <td><span className="other-month-date">1
                                        </span></td>
                                    <td><span className="other-month-date">2
                                        </span></td>
                                    <td><span className="other-month-date">3
                                        </span></td>
                                    <td><span className="other-month-date">4
                                        </span></td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div className="date-selection column p2">
                            <div><h3 className="bold text-medium-blue">Date range</h3>
                                <ul className="option-picker flex flex-wrap mt2 mb2">
                                    <li>
                                ...
                                <div>
                                    ...
                                    <span className="date-separator mod-vertical"><span>-</span></span>
                                    <div className="date-picker flex">
                                        <input />
                                        <span title="" data-original-title="Set to now">
                                            <button className="date-button">
