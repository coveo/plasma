export default function SpacedBoxes() {
    return (
        <div className="spaced-boxes-container flex flex-wrap" style={{maxWidth: 400}}>
            <span className="p2 bg-red text-pure-white spaced-box">
                A span
            </span>
            ...
            <span className="p2 bg-light-blue text-pure-white spaced-box">
                Another span
            </span>
            ...
            <span className="p2 bg-green text-pure-white spaced-box">
                More!
            </span>
        </div>
    );
