        ...
        <>
            ...
            <span className="enabled action primary action">
                <a className="inline-flex flex-center">
                    <Svg name={VaporSVG.svg.edit.name} className='action-icon' svgClass='icon fill-medium-blue'/>
                    <span className="action-label">Edit</span>
                </a>
            </span>
                        <span className="enabled action primary-action">
                <a className="inline-flex flex-center">
                    <Svg name={VaporSVG.svg.activity.name} className='action-icon' svgClass='icon fill-medium-blue'/>
                    <span className="action-label">Activity</span>
                </a>
            </span>
                        <span className="enabled action primary-action">
                <span className="enabled inline-flex flex-center">
                    <Svg name={VaporSVG.svg.copy.name} className='action-icon' svgClass='icon fill-medium-blue'/>
                ...
                <span className="dropdown-toggle inline-flex flex-center" data-toggle="dropdown">
                    <Svg name={VaporSVG.svg.more.name} className='action-icon' svgClass='icon fill-medium-blue'/>
