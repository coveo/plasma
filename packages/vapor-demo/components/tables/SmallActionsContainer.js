                    ...
                    <div className="actions-row">
                        <span className="enabled action primary action">
                            <a className="inline-flex flex-center">
                                <Svg name={VaporSVG.svg.edit.name} svgClass='icon fill-medium-blue' className='action-icon'/>
                                <span className="action-label">Edit</span>
                            </a>
                        </span>
                        <span className="enabled action primary-action">
                            <a className="inline-flex flex-center">
                                <Svg name={VaporSVG.svg.activity.name} svgClass='icon fill-medium-blue' className='action-icon'/>
                                <span className="action-label">Activity</span>
                            </a>
                        </span>
                        <span className="enabled action primary-action">
                            <span className="enabled inline-flex flex-center">
                                <Svg name={VaporSVG.svg.copy.name} svgClass='icon fill-medium-blue' className='action-icon'/>
