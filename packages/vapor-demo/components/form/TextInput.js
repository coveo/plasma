...
<div className="coveo-form">
    ...
    <div id="textarea4" className="input-field form-group validate mod-resizeable">
        <textarea className="invalid" placeholder="Placeholder text" required defaultValue="Lorem ipsum dolor sit amet, interdum est eu." />
    ...
    <div className="input-field form-group">
        ...
        <p className="description">Lorem ipsum dolor sit amet, interdum est eu. A tellus condimentum hendrerit enim, ligula fusce vitae, leo
