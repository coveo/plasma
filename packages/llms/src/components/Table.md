...
- When multi-row selection is enabled, users MAY select a row checkbox and then Shift-click another checkbox to select all selectable rows between them on the displayed page. Existing selections outside the range are preserved.
