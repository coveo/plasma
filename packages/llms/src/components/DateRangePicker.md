...
description: Date range picker that SHOULD be used when users need separate start-date and end-date inputs in a popover calendar.
---

## Props

> Extends: `BoxProps`, `PopoverProps`, `StylesApiProps<DateRangePickerFactory>`. Only Plasma-specific props are listed below; you MUST refer to Mantine documentation for inherited props.
