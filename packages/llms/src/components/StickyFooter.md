...
> Extends: `Omit<GroupProps, 'classNames' | 'styles' | 'vars' | 'variant'>`, `StylesApiProps<StickyFooterFactory>`. Only Plasma-specific props are listed below; you SHOULD refer to Mantine documentation for inherited props.

| Prop        | Type                          | Required | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                               |
| ----------- | ----------------------------- | :------: | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `borderTop` | `boolean`                     |          | `—`     | When `true`, a border is rendered on top of the footer.                                                                                                                                                                                                                                                                                                                                                                   |
| `children`  | `ReactNode`                   |          | `—`     | Footer children SHOULD usually be buttons.                                                                                                                                                                                                                                                                                                                                                                                |
| `variant`   | `'default' \| 'modal-footer'` |          | `—`     | The `modal-footer` variant SHOULD be used when rendering the `StickyFooter` inside `Modal`. The `modal-footer` variant removes the modal's default padding so that the footer properly hugs the bottom of the modal. It also adds a border on top of the footer. Deprecated: You SHOULD use `Modal.Footer` from `@coveord/plasma-mantine/Modal` for modal footers. For other cases, the `default` variant SHOULD suffice. |
