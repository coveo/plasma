...
export default () => (
    <VaporComponent id="general-guidelines" title="General Guidelines">
        <Section title="Content / Number" description="Always use a comma to separate thousand, e.g., 23,000,000." />
        ...
        >
            <Section level={2} title="Guidelines">
                <ul className="list-disc">
                    ...
                    <li>
                        <span className="bold">Avoid</span> the word <span className="bold">"please"</span>, except in
                        situations in which the user is asked to do something inconvenient (such as waiting) or the
                        software is to blame for the situation. Also note that using the word please can be interpreted
                        to mean that the required action is optional.
                    </li>
                    <li>
                        Only use the word <span className="bold">"sorry"</span> in error messages that end in{' '}
                        <span className="bold">critical problems</span> for the user (like incapacity to use the system
                        or data loss).
                    </li>
                </ul>
            </Section>
        ...
        <Section title="Messages / Warning">
            Warning messages are used to help users prevent error situations. They appear in a yellow banner at the top
            of the screen and move the content below it. It should contain a suggested next step. It should be rejected
            only by the user.
        </Section>
        ...
        <Section title="Hit Zones">
            ...
            <p>
                ...
                <span className="bold">44px by 44px</span> so that they are easy to activate on touch screens with the
                average human finger size and, with a mouse or trackpad, do not require a too precise aim.
            </p>
            <p>
                If the hit zone has to be <span className="bold">smaller for technical reasons</span>, it is important
