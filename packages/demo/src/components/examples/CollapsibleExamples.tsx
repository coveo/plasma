        ...
        <Section title="Collapsible Examples">
            <Section level={2} title="Basic" description="A simple header with collapsible content underneath">
                <CollapsibleConnected
                    ...
                    headerContent={<h6>Q: Why can't you trust an atom?</h6>}
                >
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        antilles luke. Sith hutt dantooine skywalker baba mon mon organa. Tatooine antilles wedge moff
                        hutt thrawn yoda amidala. Droid padmé c-3p0 padmé. Kit moff organa thrawn anakin dooku. Boba
                        yoda fett fett solo. Maul darth mothma fisto mace jar owen. Ahsoka calrissian moff darth maul
                        hutt windu amidala. Kamino dagobah dantooine solo tatooine ewok calrissian solo dooku.
                    </CollapsibleInfoBox>
                </Section>
                <Section level={3} title="With conditional extra content">
                    ...
                    >
                        ...
                        venom Umbridge swiveling blue eye Levicorpus, nitwit blubber oddment tweak. Chasers Winky quills
                        The Boy Who Lived bat spleens cupboard under the stairs flying motorcycle. Sirius Black Holyhead
                        Harpies, you’ve got dirt on your nose. Floating candles Sir Cadogan The Sight three hoops
                        disciplinary hearing. Grindlewald pig’s tail Sorcerer's Stone biting teacup. Side-along
                        dragon-scale suits Filch 20 points, Mr. Potter.
                    </CollapsibleInfoBox>
                </Section>
            </Section>
            <Section
                ...
                <Section level={3} title="Can be expanded from outside the component (unless disabled)">
                    <Button
                        ...
                        onClick={() => {
                            ...
                            Store.dispatch(
                                setCollapsibleExpanded('collapsible-container-example-5', !collapsibleState.expanded)
                            );
                        }}
                    />
