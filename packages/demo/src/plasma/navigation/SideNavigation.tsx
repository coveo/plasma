    ...
    return (
        <SideNavigation className="navigation-menu-sections">
            ...
            <CollapsibleSideSection title="Foundations">
                <NavLink isActive={isActive('/Effects')} disabled href="/foundations/Effects" label="Effects" />
            ...
            <CollapsibleSideSection title="Layout">
                ...
                <NavLink isActive={isActive('/ModalWizard')} href="/layout/ModalWizard" label="Modal Wizard" />
                ...
                />
                <NavLink isActive={isActive('/Section')} href="/layout/Section" label="Section" />
                <NavLink isActive={isActive('/SplitLayout')} href="/layout/SplitLayout" label="Split Layout" />
                <NavLink isActive={isActive('/Tabs')} href="/layout/Tabs" label="Tabs" />
                <NavLink isActive={isActive('/TabsConnected')} href="/layout/TabsConnected" label="Tabs Connected" />
            ...
            <CollapsibleSideSection title="Input">
                ...
                <NavLink isActive={isActive('/TextArea')} href="/input/TextArea" label="Text Area" />
