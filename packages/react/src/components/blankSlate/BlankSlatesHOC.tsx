 ...
 */
export const BlankSlateWithTable: FunctionComponent<React.PropsWithChildren<IBlankSlateWithTable>> = _.compose(
    blankSlateWithTable
)(BlankSlate);
 ...
 * @deprecated Use Plasmantine Blank-slate instead
 */
export const BlankSlateWithError: FunctionComponent<React.PropsWithChildren<IBlankSlateWithTable>> = _.compose(
    blankSlateWithError
)(BlankSlate);
