...
describe('<Table />', () => {
    ...
    describe('render', () => {
        ...
        it('should render a blankslate if no loading, empty table, isInError is true, and isInitialLoad is true (related issue: https://github.com/coveo/plasma/issues/621)', () => {
