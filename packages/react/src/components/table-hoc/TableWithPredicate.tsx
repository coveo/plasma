...
type PredicateComponentType = ComponentType<React.PropsWithChildren<IPredicateComponentProps>>;
...
type TableWithPredicateComponent = ComponentType<React.PropsWithChildren<ITableWithPredicateProps>>;
