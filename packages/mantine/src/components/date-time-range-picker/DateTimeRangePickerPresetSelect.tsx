...
import {DateTimeRangePickerValue} from './DateTimeRangePickerPopoverCalendar';

export interface DateTimeRangePickerPreset {
    label: string;
    range: DateTimeRangePickerValue;
}

interface DateTimeRangePickerPresetsSelectProps {
...
export const DateTimeRangePickerPresetSelect = ({
    presets,
    value,
    onChange,
    selectProps = {},
}: DateTimeRangePickerPresetsSelectProps) => {
