...
<Unstyled>
  <Alert.Advice title="Note" mb="md">This page covers voice and tone. For grammar, punctuation, capitalization, and other technical writing rules, see <a href="/?path=/docs/content-writing-mechanics--docs">Writing Mechanics</a>.</Alert.Advice>
</Unstyled>
