            ...
            <div className='mt2'>
                ...
                <div className='form-group'>
                    ...
                    <div className='form-group'>
                        ...
                        <div className='form-control'>
                            <Button name={'Toggle all checkboxes to disabled/enabled'} classes={['m1']} enabled={true} onClick={() => this.toggleDisabledAllCheckboxes(parentId3)} />
                        </div>
                    </div>
                    <div className='form-control'>
                        ...
                        <br />
                        <GroupableCheckboxConnected id={parentId3 + 1} parentId={parentId3} classes={['mt1 mr1']} defaultChecked={true} defaultDisabled>
                            <Label classes={['label']}>Checkbox child 1</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId3 + 2} parentId={parentId3} classes={['mt1 mr1']} defaultChecked={false} defaultDisabled>
                            <Label classes={['label']}>Checkbox child 2</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId3 + 3} parentId={parentId3} classes={['mt1 mr1']} defaultChecked={true} defaultDisabled>
                            <Label classes={['label']}>Checkbox child 3</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId3 + 4} parentId={parentId3} classes={['mt1 mr1']} defaultChecked={false} defaultDisabled>
                            <Label classes={['label']}>Checkbox child 4</Label>
                        </GroupableCheckboxConnected>
                    </div>
                </div>
                <div className='form-group'>
                    ...
                    <div className='form-control'>
                        ...
                        <div className='form-group'>
                            <label className='form-control-label'>Link Button</label>
                            <div className='form-control'>
                                <Button name={'Toggle disabled on this checkbox'} classes={['m1']} enabled={true} onClick={() => this.toggleDisabledGroupedCheckbox(parentId4 + 1, parentId4)} />
                            </div>
                        </div>
                        <GroupableCheckboxConnected id={parentId4 + 1} parentId={parentId4} classes={['mt1 mr1']} defaultChecked={true} defaultDisabled>
                            <Label classes={['label']}>Checkbox child 1</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId4 + 2} parentId={parentId4} classes={['mt1 mr1']} defaultChecked={false}>
                            <Label classes={['label']}>Checkbox child 2</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId4 + 3} parentId={parentId4} classes={['mt1 mr1']} defaultChecked={true} defaultDisabled>
                            <Label classes={['label']}>Checkbox child 3</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId4 + 4} parentId={parentId4} classes={['mt1 mr1']} defaultChecked={false}>
                            <Label classes={['label']}>Checkbox child 4</Label>
                        </GroupableCheckboxConnected>
                    </div>
                </div>
                <div className='form-group'>
                    <label className='form-control-label'>A groupable checkbox not disabled with a button to enable all</label>
                    <div className='form-group'>
                        <label className='form-control-label'>Link Button</label>
                        <div className='form-control'>
                            <Button name={'Toggle all checkboxes to disabled'} classes={['m1']} enabled={true} onClick={() => this.toggleDisabledAllCheckboxes(parentId5, true)} />
                        </div>
                    </div>
                    <div className='form-control'>
                        ...
                        <br />
                        <GroupableCheckboxConnected id={parentId5 + 1} parentId={parentId5} classes={['mt1 mr1']} defaultChecked={true}>
                            <Label classes={['label']}>Checkbox child 1</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId5 + 2} parentId={parentId5} classes={['mt1 mr1']} defaultChecked={false}>
                            <Label classes={['label']}>Checkbox child 2</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId5 + 3} parentId={parentId5} classes={['mt1 mr1']} defaultChecked={true}>
                            <Label classes={['label']}>Checkbox child 3</Label>
                        </GroupableCheckboxConnected>
                        <GroupableCheckboxConnected id={parentId5 + 4} parentId={parentId5} classes={['mt1 mr1']} defaultChecked={false}>
                            <Label classes={['label']}>Checkbox child 4</Label>
                        </GroupableCheckboxConnected>
                    </div>
                </div>
