...
export interface ISelectWithPredicateAndFilterProps extends ISelectWithPredicateProps, ISelectWithFilterProps {}
...
export const SingleSelectWithPredicateAndFilter: React.ComponentClass<ISelectWithPredicateAndFilterProps & ISingleSelectOwnProps> = selectWithFilter(selectWithPredicate(SingleSelectConnected));
...
export const MultiSelectWithPredicateAndFilter: React.ComponentClass<ISelectWithPredicateAndFilterProps & IMultiSelectOwnProps> = selectWithFilter(selectWithPredicate((MultiSelectConnected)));
