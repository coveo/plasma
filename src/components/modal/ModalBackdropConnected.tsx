...
export const ModalBackdropConnected: React.ComponentClass<IModalBackdropAllProps> = connect(mapStateToProps, mapDispatchToProps, ReduxUtils.mergeProps)(ModalBackdrop);
