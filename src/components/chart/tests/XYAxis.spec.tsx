...
describe('<XYAxis />', () => {
    ...
    it('should render as many x ticks as defined in the context', () => {
        ...
        expect(component.find('.x-axis-tick').length).toBe(XYChartContextMock.xScale.ticks(XYChartContextMock.xTicksCount).length);
    });
